...
module.exports = {
  ...
  more_info:
    "As a best practice, Kubernetes clusters should not be created with default service account. But if they are, " +
        ...
        clusters.data.forEach((cluster) => {
          ...
          if (otherScope) {
            helpers.addResult(
              results,
              2,
              "No minimal access is allowed on Kubernetes cluster",
              region,
              resource
            );
          } else {
            helpers.addResult(
              results,
              0,
              "Minimal access is allowed on Kubernetes cluster",
              region,
              resource
            );
          }
