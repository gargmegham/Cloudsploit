...
module.exports = {
  ...
  settings: {
    kubernetes_cluster_encryption_level: {
      ...
      description:
        "Desired protection level for GKE clusters. default: google-managed, cloudcmek: customer managed encryption keys, " +
  ...
  run: function (cache, settings, callback) {
    ...
    let desiredEncryptionLevelStr =
      settings.kubernetes_cluster_encryption_level ||
      this.settings.kubernetes_cluster_encryption_level.default;
            ...
            function (region, rcb) {
              ...
              clusters.data.forEach((cluster) => {
                ...
                if (
                  ...
                  cluster.databaseEncryption.state.toUpperCase() ==
                    "ENCRYPTED" &&
                  cluster.databaseEncryption.keyName &&
                  cluster.databaseEncryption.keyName.length &&
