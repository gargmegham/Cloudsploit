  ...
  describe("run", function () {
    it("should give unknown result if a clusters error is passed or no data is present", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "Unable to query Kubernetes clusters"
        );
    ...
    it("should give passing result if the default service account is not being used", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].status).to.equal(0);
        expect(results[0].message).to.include(
          "The default service account is not being used for the node pools"
        );
        expect(results[0].region).to.equal("global");
        done();
      };
      ...
      const cache = createCache(null, [
        {
          ...
          masterAuth: {
            clusterCaCertificate:
              "",
          },
          ...
          nodePools: [
            {
              ...
              selfLink:
                "https://container.googleapis.com/v1beta1/projects/frost-forest-281330/zones/us-central1-a/clusters/standard-cluster-2/nodePools/default-pool",
          ...
          ipAllocationPolicy: {
            ...
            servicesSecondaryRangeName:
              "gke-standard-cluster-2-services-c6001cf3",
          ...
          networkConfig: {
            ...
            subnetwork:
              "projects/frost-forest-281330/regions/us-central1/subnetworks/default",
          },
          privateCluster: true,
          ...
          selfLink:
            "https://container.googleapis.com/v1beta1/projects/frost-forest-281330/zones/us-central1-a/clusters/standard-cluster-2",
          zone: "us-central1-a",
          endpoint: "10.127.0.2",
    ...
    it("should give failing result if the default service account is being used", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "The default service account is being used for these node pools"
        );
        expect(results[0].region).to.equal("global");
        done();
      };
      ...
      const cache = createCache(null, [
        {
          ...
          nodePools: [
            {
              ...
              selfLink:
                "https://container.googleapis.com/v1beta1/projects/frost-forest-281330/locations/us-east1/clusters/standard-cluster-1/nodePools/default-pool",
              version: "1.12.8-gke.10",
              instanceGroupUrls: [
          ...
          ipAllocationPolicy: {
            ...
            servicesSecondaryRangeName:
              "gke-standard-cluster-1-services-1de110e2",
          ...
          networkConfig: {
            network: "projects/frost-forest-281330/global/networks/default",
            subnetwork:
              "projects/frost-forest-281330/regions/us-east1/subnetworks/default",
          },
          defaultMaxPodsConstraint: {
            maxPodsPerNode: "110",
          },
          ...
          selfLink:
            "https://container.googleapis.com/v1beta1/projects/frost-forest-281330/locations/us-east1/clusters/standard-cluster-1",
          zone: "us-east1",
