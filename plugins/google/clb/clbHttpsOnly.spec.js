...
const createCache = (
  urlMapsData,
  urlMapsErr,
  targetHttpProxiesData,
  targetHttpProxiesErr
) => {
  return {
    urlMaps: {
      list: {
        ...
        [
          {
            ...
            name: "test-clb",
            selfLink:
              "https://www.googleapis.com/compute/v1/projects/aqua-test/global/urlMaps/test-clb",
            defaultService:
              "https://www.googleapis.com/compute/v1/projects/aqua-test/global/backendServices/test-bes",
        ...
        [
          {
            ...
            name: "lb-target-2",
            selfLink:
              "https://www.googleapis.com/compute/v1/projects/aqua-test/global/targetHttpProxies/lb-target-2",
            urlMap:
              "https://www.googleapis.com/compute/v1/projects/aqua-test/global/urlMaps/test-clb",
