...
const datasetGet = [
  {
    ...
    id: "test:test",
    selfLink:
      "https://www.googleapis.com/bigquery/v2/projects/project1/datasets/test_ds",
    ...
    defaultEncryptionConfiguration: {
      kmsKeyName:
        "projects/test-dev/locations/global/keyRings/test-kr/cryptoKeys/test-key-2",
    },
  },
  {
    kind: "bigquery#dataset",
    id: "test:test",
    selfLink:
      "https://www.googleapis.com/bigquery/v2/projects/project-1/datasets/test_ds",
    datasetReference: { datasetId: "test", projectId: "test" },
    creationTime: "1619622395743",
    lastModifiedTime: "1619699668544",
    location: "US",
...
describe("tablesCMKEncrypted", function () {
  describe("run", function () {
    ...
    it("should give passing result if BigQuery dataset has desired encryption level", function (done) {
      ...
      const cache = createCache(null, [datasetGet[0]], null, cryptoKeys);
    ...
    it("should give failing result if BigQuery dataset does not have desired encryption level", function (done) {
      ...
      const cache = createCache(null, [datasetGet[1]], null, cryptoKeys);
