...
const datasetGet = [
  {
    ...
    selfLink:
      "https://www.googleapis.com/bigquery/v2/projects/aqua-dev-cloudsploit/datasets/aqua_ds",
    datasetReference: {
      datasetId: "aqua_ds",
      projectId: "aqua-dev-cloudploit",
    },
    access: [
...
describe("datasetAllUsersPolicy", function () {
  describe("run", function () {
    ...
    it("should give passing result if BigQuery dataset does not provide public access", function (done) {
      ...
      const cache = createCache(null, [datasetGet[0]]);
    ...
    it("should give failing result if BigQuery dataset provides public access", function (done) {
      ...
      const cache = createCache(null, [datasetGet[1]]);
