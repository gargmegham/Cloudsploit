...
module.exports = {
  ...
  settings: {
    bigquery_tables_encryption_protection_level: {
      ...
      description:
        "Desired protection level for BigQuery datasets. default: google-managed, cloudcmek: customer managed encryption keys, " +
  ...
  run: function (cache, settings, callback) {
    ...
    let desiredEncryptionLevelStr =
      settings.bigquery_tables_encryption_protection_level ||
      this.settings.bigquery_tables_encryption_protection_level.default;
            ...
            function (region, rcb) {
              ...
              if (datasetsGet.err || !datasetsGet.data) {
                helpers.addResult(
                  results,
                  3,
                  "Unable to query BigQuery datasets: " +
                    helpers.addError(datasetsGet),
                  region
                );
                return rcb();
              }
              ...
              async.each(datasetsGet.data, (dataset, dcb) => {
                ...
                if (
                  ...
                  currentEncryptionLevel = helpers.getProtectionLevel(
                    keysObj[dataset.defaultEncryptionConfiguration.kmsKeyName],
