...
module.exports = {
  ...
  settings: {
    service_limit_percentage_fail: {
      ...
      description:
        "Return a failing result when utilized services equals or exceeds this percentage",
      regex: "^(100|[1-9][0-9]?)$",
      default: 90,
    },
    service_limit_percentage_warn: {
      ...
      description:
        "Return a warning result when utilized services equals or exceeds this percentage",
      regex: "^(100|[1-9][0-9]?)$",
      default: 75,
    },
  },
  ...
  run: function (cache, settings, callback) {
    var config = {
      service_limit_percentage_fail:
        ...
        this.settings.service_limit_percentage_fail.default,
      service_limit_percentage_warn:
        settings.service_limit_percentage_warn ||
        this.settings.service_limit_percentage_warn.default,
    };
        ...
        projects.data.forEach((project) => {
          ...
          if (!failTrigger && !warnTrigger) {
            helpers.addResult(
              results,
              0,
              "All resources are within the service limits",
              region
            );
          }
        });
