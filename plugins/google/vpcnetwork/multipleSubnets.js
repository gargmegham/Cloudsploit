        ...
        networks.data.forEach((network) => {
          ...
          if (passNetworks.length) {
            let msg =
              "There are " +
              myRegions[sub] +
              " different subnets used in these regions: ";
            helpers.addResult(
              results,
              0,
              msg + passNetworks.join(", "),
              null,
              resource
            );
          }
          ...
          if (noNetworks.length) {
            ...
            helpers.addResult(results, 0, msg, null, resource);
          }
        });
