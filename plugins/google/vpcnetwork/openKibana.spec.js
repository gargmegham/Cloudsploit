...
const firewalls = [
  {
    ...
    network:
      "https://www.googleapis.com/compute/v1/projects/aqua-dev-akhtar/global/networks/app-vpc",
    priority: 1000,
    ...
    disabled: false,
    selfLink:
      "https://www.googleapis.com/compute/v1/projects/aqua-dev-akhtar/global/firewalls/openall",
  ...
  },
  {
    ...
    disabled: false,
    selfLink:
      "https://www.googleapis.com/compute/v1/projects/aqua-dev-akhtar/global/firewalls/opensome",
    kind: "compute#firewall",
  },
];
...
describe("openKibana", function () {
  describe("run", function () {
    ...
    it("should UNKNWON if unable to describe firewall rules", function (done) {
      const cache = createCache([], {
        message: "Unable to query firewall rules",
      });
      openKibana.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
