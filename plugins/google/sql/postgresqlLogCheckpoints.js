        ...
        sqlInstances.data.forEach((sqlInstance) => {
          ...
          if (
            ...
            helpers.addResult(
              results,
              0,
              "SQL instance database version is not of PosgreSQL type",
              region,
              resource
            );
            return;
          ...
          if (sqlInstance.settings && sqlInstance.settings.databaseFlags) {
            ...
            if (found) {
              helpers.addResult(
                results,
                0,
                "PostgreSQL instance has log_checkpoints flag enabled",
                region,
                resource
              );
            } else {
              helpers.addResult(
                results,
                2,
                "PostgreSQL instance does not have log_checkpoints flag enabled",
                region,
                resource
              );
            }
