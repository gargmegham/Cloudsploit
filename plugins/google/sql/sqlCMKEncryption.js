...
module.exports = {
  ...
  settings: {
    sql_encryption_protection_level: {
      ...
      description:
        "Desired protection level for Google Cloud SQL instances. default: google-managed, cloudcmek: customer managed encryption keys, " +
  ...
  run: function (cache, settings, callback) {
    ...
    let desiredEncryptionLevelStr =
      settings.sql_encryption_protection_level ||
      this.settings.sql_encryption_protection_level.default;
            ...
            function (region, rcb) {
              ...
              if (sqlInstances.err || !sqlInstances.data) {
                helpers.addResult(
                  results,
                  3,
                  "Unable to query SQL instances: " +
                    helpers.addError(sqlInstances),
                  region
                );
                return rcb();
              }
              ...
              sqlInstances.data.forEach((sqlInstance) => {
                if (
                  ...
                  sqlInstance.instanceType.toUpperCase() ===
                ...
                if (
                  sqlInstance.diskEncryptionConfiguration &&
                  sqlInstance.diskEncryptionConfiguration.kmsKeyName
                ) {
                  currentEncryptionLevel = helpers.getProtectionLevel(
                    keysObj[sqlInstance.diskEncryptionConfiguration.kmsKeyName],
