...
module.exports = {
  ...
  more_info:
    "Enabling Contained Database Authentication flag allows users to connect to the database without authenticating " +
          ...
          if (
            ...
            if (found) {
              helpers.addResult(
                results,
                0,
                "SQL instance has contained database authentication flag disabled",
                region,
                resource
              );
            } else {
              helpers.addResult(
                results,
                2,
                "SQL instance has contained database authentication flag enabled",
                region,
                resource
              );
            }
