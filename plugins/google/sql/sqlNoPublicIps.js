    ...
    async.each(
      ...
      function (region, rcb) {
        ...
        sqlInstances.data.forEach((sqlInstance) => {
          ...
          if (sqlInstance.ipAddresses && sqlInstance.ipAddresses.length) {
            let found = sqlInstance.ipAddresses.find(
              (address) => address.type.toUpperCase() == "PRIMARY"
            );
            ...
            if (found) {
              ...
              helpers.addResult(
                results,
                0,
                "SQL instance does not have public IPs",
                region,
                resource
              );
            }
