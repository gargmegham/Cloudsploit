        ...
        [
          {
            ...
            instanceGroup:
              "https://www.googleapis.com/compute/v1/projects/my-project-1/zones/us-central1-a/instanceGroups/instance-group-1",
      ...
      const cache = createCache([
        {
          ...
          autoHealingPolicies: [
            {
              healthCheck:
                "https://www.googleapis.com/compute/v1/projects/my-project/global/healthChecks/hc-1",
              initialDelaySec: 300,
            },
          ],
        },
