          ...
          function (zone, zcb) {
            ...
            instances.data.forEach((instance) => {
              ...
              if (instance.serviceAccounts && instance.serviceAccounts.length) {
                found = instance.serviceAccounts.find(
                  (serviceAccount) =>
                    serviceAccount.scopes &&
                    serviceAccount.scopes.indexOf(
              ...
              if (found) {
                helpers.addResult(
                  results,
                  2,
                  "Instance Service account has full access",
                  region,
                  resource
                );
              } else {
                helpers.addResult(
                  results,
                  0,
                  "Instance Service account follows least privilege",
                  region,
                  resource
                );
              }
