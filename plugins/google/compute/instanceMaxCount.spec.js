...
describe("instanceMaxCount", function () {
  describe("run", function () {
    ...
    it("should fail if VM instance count is not within regional threshold", function (done) {
        ...
        [
          {
            ...
            description: "",
            machineType:
              "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-east1-b/machineTypes/n1-standard-1",
            status: "RUNNING",
            zone: "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-east1-b",
            selfLink:
              "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-east1-b/instances/instance-3",
          },
          {
            kind: "compute#instance",
            id: "1111111",
            ...
            zone: "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-east1-b",
            selfLink:
              "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-east1-b/instances/instance-2",
          },
        ],
        null
      );
      ...
      plugin.run(
        cache,
        { instance_count_region_threshold_us_east1: 1 },
        callback
      );
    });
    ...
    it("should pass if VM instance count is within regional threshold", function (done) {
      ...
      const cache = createCache([
        {
          ...
          description: "",
          machineType:
            "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-east1-b/machineTypes/g1-small",
          status: "RUNNING",
          zone: "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-east1-b",
          canIpForward: false,
          selfLink:
      ...
      plugin.run(
        cache,
        { instance_count_region_threshold_us_east1: 100 },
        callback
      );
    });
