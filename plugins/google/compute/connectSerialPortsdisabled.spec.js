  ...
  describe("run", function () {
    it("should give unknown if an instance error occurs", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "Unable to query compute instances"
        );
    ...
    it("should fail if Connecting to Serial Ports is enabled for the instance", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "Connecting to Serial Ports is enabled for the instance"
        );
        expect(results[0].region).to.equal("us-central1");
        done();
      };
        ...
        [
          {
            ...
            machineType:
              "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-central1-a/machineTypes/n1-standard-1",
            status: "RUNNING",
            ...
            networkInterfaces: [
              {
                ...
                network:
                  "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/global/networks/default",
                subnetwork:
                  "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/regions/us-central1/subnetworks/default",
            ...
            disks: [
              {
                ...
                mode: "READ_WRITE",
                source:
                  "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-central1-a/disks/instance-3",
            ...
            selfLink:
              "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-central1-a/instances/instance-3",
            scheduling: {
    ...
    it("should pass if Connecting to Serial Ports is disabled for the instance", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.equal(
          "Connecting to Serial Ports is disabled for the instance"
        );
        expect(results[0].region).to.equal("us-central1");
        done();
      };
      ...
      const cache = createCache([
        {
          ...
          machineType:
            "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-central1-a/machineTypes/g1-small",
          status: "RUNNING",
          zone: "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-central1-a",
          canIpForward: false,
          networkInterfaces: [
          ...
          disks: [
            {
              ...
              mode: "READ_WRITE",
              source:
                "https://www.googleapis.com/compute/v1/projects/rosy-booth-253119/zones/us-central1-a/disks/instance-2",
