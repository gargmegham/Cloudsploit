...
module.exports = {
  ...
  more_info:
    "Compute Instances should always be configured behind load balancers instead of having public IP addresses " +
          ...
          function (zone, zcb) {
            ...
            instances.data.forEach((instance) => {
              ...
              if (
                ...
                found = instance.networkInterfaces.find(
                  (networkObject) => networkObject.accessConfigs
                );
              }
              ...
              if (found) {
                helpers.addResult(
                  results,
                  2,
                  "Public access is enabled for the instance",
                  region,
                  resource
                );
              } else {
                helpers.addResult(
                  results,
                  0,
                  "Public access is disabled for the instance",
                  region,
                  resource
                );
              }
