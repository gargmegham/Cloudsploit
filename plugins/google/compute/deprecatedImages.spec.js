          ...
          data: [
            {
              ...
              diskSizeGb: "10",
              sourceDisk:
                "https://www.googleapis.com/compute/v1/projects/my-project/zones/us-central1-a/disks/disk-1",
              sourceDiskId: "11111",
              selfLink:
...
const diskData = [
  {
    ...
    status: "READY",
    selfLink:
      "https://www.googleapis.com/compute/v1/projects/my-project/zones/us-central1-a/disks/instance-2",
    sourceImage:
      "https://www.googleapis.com/compute/v1/projects/debian-cloud/global/images/debian-10-buster-v20210916",
    sourceImageId: "11611",
  ...
  },
  {
    ...
    status: "READY",
    selfLink:
      "https://www.googleapis.com/compute/v1/projects/my-project/zones/us-central1-a/disks/instance-1",
    sourceImage:
      "https://www.googleapis.com/compute/v1/projects/my-project/global/images/image-2",
    sourceImageId: "11511",
    kind: "compute#disk",
...
describe("deprecatedImages", function () {
  describe("run", function () {
    it("should give unknown if an instance error occurs", function (done) {
      ...
      const cache = createCache([], ["error"], null, diskData, null);
    ...
    it("should pass no VM Instances", function (done) {
      ...
      const cache = createCache([], null, diskData, null);
    ...
    it("should fail if instance is created from a deprecated image", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "Instance is created from a deprecated image"
        );
        expect(results[0].region).to.equal("us-central1");
        done();
      };
        ...
        [
          {
            ...
            name: "instance-1",
            machineType:
              "https://www.googleapis.com/compute/v1/projects/my-project/zones/us-central1-a/machineTypes/e2-micro",
            status: "RUNNING",
            zone: "https://www.googleapis.com/compute/v1/projects/my-project/zones/us-central1-a",
            canIpForward: false,
            disks: [
    ...
    it("should pass if instance is not created from a deprecated image", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.equal(
          "Instance is not created from a deprecated image"
        );
        expect(results[0].region).to.equal("us-central1");
        done();
      };
