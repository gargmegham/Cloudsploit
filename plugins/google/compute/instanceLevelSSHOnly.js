          ...
          function (zone, zcb) {
            ...
            instances.data.forEach((instance) => {
              ...
              if (
                ...
                found = instance.metadata.items.find(
                  (metaItem) =>
                    metaItem.key === "block-project-ssh-keys" &&
                    metaItem.value &&
                    metaItem.value.toUpperCase() === "TRUE"
                );
              }
              ...
              if (found) {
                helpers.addResult(
                  results,
                  0,
                  "Block project-wide SSH keys is enabled for the instance",
                  region,
                  resource
                );
              } else {
                helpers.addResult(
                  results,
                  2,
                  "Block project-wide SSH keys is disabled for the instance",
                  region,
                  resource
                );
              }
