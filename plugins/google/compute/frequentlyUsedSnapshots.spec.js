    ...
    it("should give unknown if unable to query compute disk snapshots", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "Unable to query for disk snapshots"
        );
        ...
        [
          {
            ...
            status: "READY",
            sourceDisk:
              "https://www.googleapis.com/compute/v1/projects/my-project-1/zones/us-central1-a/disks/disk-1",
            sourceDiskId: "7633933784896409327",
            diskSizeGb: "10",
            storageBytes: "0",
            storageBytesStatus: "UP_TO_DATE",
            selfLink:
              "https://www.googleapis.com/compute/v1/projects/my-project-1/global/snapshots/snapshot-1",
        ...
        [
          {
            ...
            diskSizeGb: "10",
            selfLink:
              "https://www.googleapis.com/compute/v1/projects/my-project-1/global/images/image-1",
            labelFingerprint: "42WmSpB8rSM=",
            sourceSnapshot:
              "https://www.googleapis.com/compute/v1/projects/my-project-1/global/snapshots/snapshot-1",
