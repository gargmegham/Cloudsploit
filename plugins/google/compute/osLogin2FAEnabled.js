          ...
          function (zone, zcb) {
            ...
            instances.data.forEach((instance) => {
              ...
              if (
                ...
                if (
                  instance.metadata.items.find(
                    (item) =>
                      item.key &&
                      item.key.toLowerCase() === "enable-oslogin-2fa" &&
                      item.value &&
              ...
              if (isEnabled) {
                helpers.addResult(
                  results,
                  0,
                  "OS Login 2FA is enabled for the the instance",
                  region,
                  resource
                );
              } else {
                helpers.addResult(
                  results,
                  2,
                  "OS Login 2FA is not enabled for the the instance",
                  region,
                  resource
                );
              }
