...
module.exports = {
  ...
  settings: {
    pubsub_topic_encryption_level: {
      ...
      description:
        "Desired protection level for Pub/Sub topics. default: google-managed, cloudcmek: customer managed encryption keys, " +
  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      desiredEncryptionLevelStr:
        settings.pubsub_topic_encryption_level ||
        this.settings.pubsub_topic_encryption_level.default,
    };
            ...
            function (tregion, trcb) {
              ...
              if (topics.err || !topics.data) {
                helpers.addResult(
                  results,
                  3,
                  "Unable to query for Pub/Sub topics: " +
                    helpers.addError(topics),
                  tregion,
                  null,
                  null,
                  topics.err
              ...
              async.each(
                ...
                (topic, tcp) => {
                  ...
                  if (
                    topic.kmsKeyName &&
                    topic.kmsKeyName.length &&
                    keysObj[topic.kmsKeyName]
                  ) {
