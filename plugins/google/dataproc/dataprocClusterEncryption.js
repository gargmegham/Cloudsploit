...
module.exports = {
  ...
  settings: {
    dataproc_cluster_encryption_level: {
      ...
      description:
        "Desired protection level for Dataproc clusters. default: google-managed, cloudcmek: customer managed encryption keys, " +
  ...
  run: function (cache, settings, callback) {
    ...
    let desiredEncryptionLevelStr =
      settings.dataproc_cluster_encryption_level ||
      this.settings.dataproc_cluster_encryption_level.default;
              ...
              if (clusters && clusters.data) {
                clusters.data.forEach((cluster) => {
                  ...
                  if (
                    cluster &&
                    cluster.config &&
                    cluster.config.encryptionConfig &&
