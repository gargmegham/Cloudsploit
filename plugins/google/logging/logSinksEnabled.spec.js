  ...
  describe("run", function () {
    ...
    it("should give passing result if the log sink is properly configured", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "The log sink is properly configured"
        );
        expect(results[0].region).to.equal("global");
        done();
      };
        ...
        [
          {
            name: "bigquerytest1",
            destination:
              "bigquery.googleapis.com/projects/free-ocean-281330/datasets/bigquerytest1",
            filter: 'resource.type="all_resources"',
            outputVersionFormat: "V2",
            writerIdentity:
              "serviceAccount:p281330800432-544288@gcp-sa-logging.iam.gserviceaccount.com",
            bigqueryOptions: {},
          ...
          },
          {
            ...
            outputVersionFormat: "V2",
            writerIdentity:
              "serviceAccount:p281330800432-489680@gcp-sa-logging.iam.gserviceaccount.com",
          ...
          },
          {
            name: "pubsubtest1",
            destination:
              "pubsub.googleapis.com/projects/free-ocean-281330/topics/giotest1",
            filter: 'resource.type="audited_resource"',
            outputVersionFormat: "V2",
            writerIdentity:
              "serviceAccount:p281330800432-527679@gcp-sa-logging.iam.gserviceaccount.com",
          ...
          },
          {
            ...
            outputVersionFormat: "V2",
            writerIdentity:
              "serviceAccount:p281330800432-910275@gcp-sa-logging.iam.gserviceaccount.com",
        ...
        [
          {
            ...
            id: "bbbucket12324536",
            selfLink:
              "https://www.googleapis.com/storage/v1/b/bbbucket12324536",
          ...
          },
          {
            ...
            id: "ggtestbucketsink",
            selfLink:
              "https://www.googleapis.com/storage/v1/b/ggtestbucketsink",
            projectNumber: "281330800432",
    ...
    it("should give failing result if bucket versioning is disabled", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[1].message).to.include(
          "Log bucket versioning is disabled"
        );
        expect(results[1].region).to.equal("global");
        done();
      };
    ...
    it("should give failing result if the log bucket does not exist", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].status).to.equal(2);
        expect(results[0].message).to.include(
          "The log bucket: ggtestbucketsink does not exist"
        );
        expect(results[0].region).to.equal("global");
        done();
      };
