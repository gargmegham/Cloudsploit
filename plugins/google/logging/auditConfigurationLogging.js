...
module.exports = {
  ...
  compliance: {
    ...
    pci:
      "PCI has a strict requirement to log all account activity " +
        ...
        if (metricExists && metricName.length) {
                ...
                if (
                  ...
                  if (conditionFilter === metricName) {
                    ...
                    helpers.addResult(
                      results,
                      0,
                      "Log alert for audit configuration changes is enabled",
                      region,
                      alertPolicy.name
                    );
                  }
          ...
          if (!conditionFound) {
            helpers.addResult(
              results,
              2,
              "Log alert for audit configuration changes not found",
              region
            );
          }
        } else {
          helpers.addResult(
            results,
            2,
            "Log metric for audit configuration changes not found",
            region
          );
        }
