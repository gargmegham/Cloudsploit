...
const listBrokers = [
  {
    BrokerArn:
      "arn:aws:mq:us-east-1:000111222333:broker:myBr1:b-5bf97c6e-1ce8-48da-9200-ecd32b861be9",
...
const describeBroker = [
  {
    ...
    BrokerArn:
      "arn:aws:mq:us-east-1:000111222333:broker:MyBroker12:b-127b45ef-fa90-40f4-bf8b-5a7c19b66cad",
    BrokerId: "b-127b45ef-fa90-40f4-bf8b-5a7c19b66cad",
    BrokerInstances: [
      {
        ConsoleURL:
          "https://b-127b45ef-fa90-40f4-bf8b-5a7c19b66cad-1.mq.us-east-1.amazonaws.com:8162",
        Endpoints: [Array],
    ...
    Logs: {
      Audit: false,
      AuditLogGroup:
        "/aws/amazonmq/broker/b-5bf97c6e-1ce8-48da-9200-ecd32b861be9/audit",
      General: true,
      GeneralLogGroup:
        "/aws/amazonmq/broker/b-5bf97c6e-1ce8-48da-9200-ecd32b861be9/general",
    },
    BrokerName: "myBr1",
    BrokerState: "RUNNING",
  },
...
const createCache = (listBrokers, describeBroker, listErr, getErr) => {
  var broker =
    listBrokers && listBrokers.length ? listBrokers[0].BrokerId : null;
  return {
    mq: {
      listBrokers: {
        "us-east-1": {
...
describe("mqLogExports", function () {
  describe("run", function () {
    ...
    it("should UNKNOWN if unable to list MQ Brokers", function (done) {
      const cache = createCache(listBrokers, describeBroker[0], {
        message: "error listing MQ brokers",
      });
      mqLogExports.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
