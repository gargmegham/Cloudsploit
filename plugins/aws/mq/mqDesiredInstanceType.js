...
module.exports = {
  ...
  more_info:
    "Set limits for the type of Amazon MQ broker instances created in your AWS account to address internal compliance " +
  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      mq_desired_instance_type:
        settings.mq_desired_instance_type ||
        this.settings.mq_desired_instance_type.default,
    };

    if (!config.mq_desired_instance_type.length)
      ...
      function (region, rcb) {
        ...
        for (var broker of listBrokers.data) {
          ...
          if (
            ...
            broker.HostInstanceType.length &&
