...
const listBrokers = [
  {
    BrokerArn:
      "arn:aws:mq:us-east-1:000011112222:broker:sadeed-br:b-a67fb4c0-2f23-46cf-98cb-7015bd36e1b4",
  ...
  {
    BrokerArn:
      "arn:aws:mq:us-east-1:000011112222:broker:sadeed-br3:b-b4cfface-0aa9-4922-b41d-07fab046cef3",
  ...
  {
    BrokerArn:
      "arn:aws:mq:us-east-1:000011112222:broker:mybr1:b-043833c7-190c-4ebf-bbe7-8d930f9f9124",
...
const describeBroker = [
  {
    ...
    EncryptionOptions: {
      KmsKeyId:
        "arn:aws:kms:us-east-1:000011112222:key/26fb32cb-1abc-4096-93eb-1fa0c6e6efb4",
  ...
  },
  {
    ...
    BrokerInstances: [
      {
        ConsoleURL:
          "https://b-a67fb4c0-2f23-46cf-98cb-7015bd36e1b4-1.mq.us-east-1.amazonaws.com:8162",
        Endpoints: [
  ...
  describe("run", function () {
    ...
    it("should UNKNOWN if unable to list MQ Broker", function (done) {
      const cache = createCache(null, null, null, {
        message: "Unable to list MQ Broker",
      });
      mqBrokerEncrypted.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
    ...
    it("should UNKNOWN if unable to list KMS keys", function (done) {
      const cache = createCache(listBrokers, null, null, null, {
