...
const getEnvironment = [
  {
    Environment: {
      ...
      ExecutionRoleArn:
        "arn:aws:iam::000011112222:role/service-role/AmazonMWAA-role-1",
      Name: "env-1",
      NetworkConfiguration: {
        SecurityGroupIds: ["sg-06bb33bc2a9d6cfa0", "sg-0356a73d9749f97ad"],
        SubnetIds: ["subnet-027b3e2dbd13be412", "subnet-0ba3663b2ac3734d2"],
      },
  ...
  },
  {
    Environment: {
      Arn: "arn:aws:airflow:us-east-1:000011112222:environment/env-1",
      ExecutionRoleArn:
        "arn:aws:iam::000011112222:role/service-role/AmazonMWAA-role-2",
      Name: "env-1",
      NetworkConfiguration: {
        SecurityGroupIds: ["sg-06bb33bc2a9d6cfa0", "sg-0356a73d9749f97ad"],
        SubnetIds: ["subnet-027b3e2dbd13be412", "subnet-0ba3663b2ac3734d2"],
...
const createCache = (
  ...
  var envName =
    listEnvironments && listEnvironments.length ? listEnvironments[0] : null;
