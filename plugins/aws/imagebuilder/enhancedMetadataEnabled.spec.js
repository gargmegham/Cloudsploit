...
const listImagePipelines = [
  {
    ...
    imageRecipeArn:
      "arn:aws:imagebuilder:us-east-1:000011112222:image-recipe/akhtar-img-rc/1.0.0",
    infrastructureConfigurationArn:
      "arn:aws:imagebuilder:us-east-1:000011112222:infrastructure-configuration/akhtar-img-pipeline-914d5fdf-45db-4231-ae0e-991c39f9e594",
    distributionConfigurationArn:
      "arn:aws:imagebuilder:us-east-1:000011112222:distribution-configuration/akhtar-img-pipeline-914d5fdf-45db-4231-ae0e-991c39f9e594",
  ...
  describe("run", () => {
    ...
    it("should PASS if No image pipeline list found", () => {
      ...
      enhancedMetadataEnabled.run(cache, {}, (err, results) => {
        ...
        expect(results[0].status).to.equal(0);
        expect(results[0].message).to.include(
          "No Image Builder image pipelines found"
        );
        expect(results[0].region).to.equal("us-east-1");
      });
    });
