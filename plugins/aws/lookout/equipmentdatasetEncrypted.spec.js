...
const listDatasets = [
  {
    DatasetName: "sadeed1",
    DatasetArn:
      "arn:aws:lookoutequipment:us-east-1:000011112222:dataset/sadeed1/7e416b3a-c317-44ed-9f51-1430d2191319",
    Status: "CREATED",
  ...
  },
  {
    DatasetName: "sadeed2",
    DatasetArn:
      "arn:aws:lookoutequipment:us-east-1:000011112222:dataset/sadeed2/7e416b3a-c317-44ed-9f51-1430d2191319",
    Status: "CREATED",
    CreatedAt: "2021-12-15T20:25:41.181000+05:00",
  },
];
...
const createCache = (
  ...
  var datasetName =
    datasets && datasets.length ? datasets[0].DatasetName : null;
  return {
    lookoutequipment: {
      listDatasets: {
        "us-east-1": {
  ...
  describe("run", function () {
    ...
    it("should UNKNOWN if unable to list LookoutEquipment Datasets", function (done) {
      const cache = createCache(
        ...
        describeDataset[1],
        describeKey[1],
        { message: "Unable to list LookoutEquipment Datasets" }
      );
      equipmentdatasetEncrypted.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
    ...
    it("should UNKNOWN if unable to list KMS keys", function (done) {
      const cache = createCache(listDatasets, null, null, null, null, {
