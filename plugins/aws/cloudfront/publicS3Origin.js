        ...
        for (var o in distribution.Origins.Items) {
          ...
          if (
            ...
            helpers.addResult(
              results,
              2,
              "CloudFront distribution is using an S3 " +
                "origin without an origin access identity",
              "global",
              distribution.ARN
            );
          } else {
            helpers.addResult(
              results,
              0,
              "CloudFront distribution origin is not setup " +
                "without an origin access identity",
              "global",
              distribution.ARN
            );
          }
