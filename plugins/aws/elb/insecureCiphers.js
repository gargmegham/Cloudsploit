...
module.exports = {
  ...
  compliance: {
    hipaa:
      "All HIPAA data should be encrypted in transit. Using secure ciphers " +
          ...
          function (lb, cb) {
            ...
            if (
              ...
              helpers.addResult(
                results,
                3,
                "Unable to query load balancer policies for ELB: " +
                  lb.LoadBalancerName +
                  ": " +
            ...
            for (var i in describeLoadBalancerPolicies.data
              .PolicyDescriptions) {
              var policyDesc =
                describeLoadBalancerPolicies.data.PolicyDescriptions[i];
              ...
              for (var j in policyDesc.PolicyAttributeDescriptions) {
                ...
                if (
                  policyAttrDesc.AttributeValue === "true" &&
