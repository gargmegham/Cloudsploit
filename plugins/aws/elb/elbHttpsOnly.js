...
module.exports = {
  ...
  actions: {
    remediate: ["ELB:deleteLoadBalancerListeners"],
    rollback: ["ELB:createLoadBalancerListeners"],
  },
  permissions: {
    remediate: ["elasticloadbalancing:DeleteLoadBalancerListeners"],
    rollback: ["elasticloadbalancing:CreateLoadBalancerListeners"],
  },
  realtime_triggers: [
          ...
          function (lb, cb) {
            ...
            if (non_https_listeners.length) {
              helpers.addResult(
                ...
                `Elb "${
                  lb.LoadBalancerName
                }" is using these listeners ${non_https_listeners.join(
                  ", "
  ...
  remediate: function (config, cache, settings, resource, callback) {
    ...
    if (
      failingLoadBalancer &&
      failingLoadBalancer.ListenerDescriptions &&
      failingLoadBalancer.ListenerDescriptions.length
    ) {
