...
const listBackupPlans = [
  {
    BackupPlanArn:
      "arn:aws:backup:us-east-1:000011112222:backup-plan:07ade659-ed39-4a80-a62c-267828ca315a",
  ...
  {
    BackupPlanArn:
      "arn:aws:backup:us-east-1:000011112222:backup-plan:07ade659-ed39-4a80-a62c-267828ca325a",
    BackupPlanId: "07ade659-ed39-4a80-a62c-267828ca315a",
    CreationDate: "2022-01-21T16:19:55.937000+05:00",
  ...
  describe("run", function () {
    ...
    it("should UNKNOWN if Unable to list Backup plans", function (done) {
      const cache = createCache(null, null, {
        message: "Unable to list Backup plans",
      });
      compliantLifecyleConfigured.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
