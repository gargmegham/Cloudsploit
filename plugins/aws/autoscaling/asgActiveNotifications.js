    ...
    async.each(
      ...
      function (region, rcb) {
        ...
        async.each(describeAutoScalingGroups.data, function (asg, cb) {
          ...
          if (
            ...
            helpers.addResult(
              ...
              "Unable to query for auto scaling group notification configurations: " +
                helpers.addError(notificationConfiguration),
              region,
              resource
            );
            return cb();
          ...
          if (
            !notificationConfiguration.data.NotificationConfigurations ||
            ...
            helpers.addResult(
              ...
              "Auto scaling group: " +
                ...
                " does not have notifications active",
              region,
              resource
            );
            return cb();
