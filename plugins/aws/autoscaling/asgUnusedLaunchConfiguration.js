      ...
      function (region, rcb) {
        ...
        if (
          ...
          helpers.addResult(
            ...
            "Unable to query for Auto Scaling groups: " +
              helpers.addError(describeAutoScalingGroups),
            region
          );
          return rcb();
        }
        ...
        describeLaunchConfigurations.data.forEach((config) => {
          ...
          if (
            ...
            usedLaunchConfig.includes(config.LaunchConfigurationName)
          ) {
            helpers.addResult(
              results,
              0,
