      ...
      function (region, rcb) {
        ...
        if (
          ...
          helpers.addResult(
            results,
            3,
            `Unable to query for Auto Scaling group launch configurations: ${helpers.addError(
              describeLaunchConfigurations
            )}`,
            region
          );
        ...
        describeLaunchConfigurations.data.forEach((config) => {
          ...
          launchConfigurations[config.LaunchConfigurationName] =
        ...
        for (var g in describeAutoScalingGroups.data) {
          ...
          if (
            ...
            asg.LaunchConfigurationName.length
          ) {
        ...
        if (!launchConfigurationAsgFound) {
          helpers.addResult(
            results,
            0,
            "No Auto Scaling groups utilizing launch configurations found",
            region
          );
          return rcb();
        }
        ...
        if (!webTierAsgFound) {
          helpers.addResult(
            results,
            0,
            "No Web-Tier Auto Scaling groups with found",
            region
          );
        }
