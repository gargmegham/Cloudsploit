...
const describeAutoScalingGroups = [
  {
    ...
    AutoScalingGroupARN:
      "arn:aws:autoscaling:us-east-1:111122223333:autoScalingGroup:d18695a1-726b-4011-9c1e-2f648fccbc26:autoScalingGroupName/test-36",
  ...
  },
  {
    ...
    AutoScalingGroupARN:
      "arn:aws:autoscaling:us-east-1:112233445566:autoScalingGroup:d4c0bbe4-e7d6-4d9b-89f1-06021f06a117:autoScalingGroupName/test3-36",
    LaunchTemplate: {
      LaunchTemplateId: "lt-0f1f6b356026abc86",
      LaunchTemplateName: "auto-scaling-template",
      Version: "$Default",
...
const describeLaunchConfigurations = [
  {
    ...
    LaunchConfigurationARN:
      "arn:aws:autoscaling:us-east-1:111122223333:launchConfiguration:f20acca0-07b4-4cec-9174-75547b193446:launchConfigurationName/test-lc-43",
    ImageId: "ami-02354e95b39ca8dec",
    KeyName: "auto-scaling-test-instance",
    SecurityGroups: ["sg-06cccc47e5b3e1ee9"],
    ...
    IamInstanceProfile:
      "arn:aws:iam::111122223333:instance-profile/aws-elasticbeanstalk-ec2-role",
