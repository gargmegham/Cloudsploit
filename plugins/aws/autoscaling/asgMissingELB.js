        ...
        autoScalingGroups.data.forEach(function (asg) {
          ...
          if (asg.HealthCheckType && asg.HealthCheckType === "ELB") {
            if (asg.LoadBalancerNames && asg.LoadBalancerNames.length) {
              ...
              if (inactiveElbs.length) {
                helpers.addResult(
                  results,
                  2,
                  "Auto Scaling group utilizes these inactive load balancers: " +
                    inactiveElbs.join(", "),
                  region,
                  resource
                );
                ...
                helpers.addResult(
                  ...
                  "Auto Scaling group: " +
                    ...
                    " utilizes active load balancers",
                  region,
                  resource
                );
              }
              ...
              helpers.addResult(
                results,
                2,
                "Auto Scaling group does not have any Load Balancer associated",
                region,
                resource
              );
            }
            ...
            helpers.addResult(
              results,
              0,
              "Auto Scaling group does not utilize a load balancer",
              region,
              resource
            );
          }
