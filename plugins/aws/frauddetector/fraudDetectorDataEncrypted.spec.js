...
const getKMSEncryptionKeyCMK = {
  kmsEncryptionKeyArn:
    "arn:aws:kms:us-east-1:111222333444:key/ad013a33-b01d-4d88-ac97-127399c18b3e",
};
  ...
  describe("run", function () {
    it("should PASS if Fraud Detector data is encrypted with desired encryption level", function (done) {
      const cache = createCache(
        getDetectors,
        getKMSEncryptionKeyCMK,
        listKeys,
        describeKey[0]
      );
      fraudDetectorDataEncrypted.run(
        cache,
        { fraud_detector_data_encryption_level: "awscmk" },
        (err, results) => {
