...
const listStacks = [
  {
    StackId:
      "arn:aws:cloudformation:us-east-1:111122223333:stack/AKD/081ed430-3733-11eb-a560-12e26def3eab",
    StackName: "AKD",
...
const describeStacks = [
  ...
  },
  {
    Stacks: [
      {
        StackId:
          "arn:aws:cloudformation:us-east-1:55005500:stack/TestStack/1493b310-dc80-11ea-b8ab-1214c28caebf",
        StackName: "AKD",
        Parameters: [],
        CreationTime: "2020-08-12T09:42:04.803Z",
        RollbackConfiguration: {},
...
const createCache = (stacks, stackDetails) => {
  var stackName =
    stacks && stacks.length && stacks[0].StackName ? stacks[0].StackName : null;
  return {
    cloudformation: {
      listStacks: {
        "us-east-1": {
