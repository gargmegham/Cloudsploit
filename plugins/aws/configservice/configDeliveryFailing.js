      ...
      function (region, rcb) {
        ...
        if (
          ...
          helpers.addResult(
            results,
            3,
            "Unable to query for Config Service configuration recorder statuses: " +
        ...
        if (!describeConfigurationRecorderStatus.data.length) {
          helpers.addResult(
            results,
            0,
            "No Config Service configuration recorder statuses found",
            region
          );
          return rcb();
        }
        ...
        if (
          describeConfigurationRecorderStatus.data[0].lastStatus &&
          describeConfigurationRecorderStatus.data[0].lastStatus.toUpperCase() ===
            "SUCCESS"
        ) {
          helpers.addResult(
            results,
