...
module.exports = {
  ...
  run: function (cache, settings, callback) {
    ...
    const enabledButAllowsWorldString =
    ...
    async.each(
      ...
      function (region, rcb) {
        ...
        var listDirectories = helpers.addSource(cache, source, [
          "workspaces",
          "describeWorkspaceDirectories",
          region,
          "data",
        ]);
        var listIPGroups = helpers.addSource(cache, source, [
          "workspaces",
          "describeIpGroups",
          region,
          "data",
        ...
        for (var workspace of listWorkspaces) {
          ...
          var workspaceDirectory = listDirectories.find(
            (directory) => directory.DirectoryId === workspace.DirectoryId
          );
          ...
          if (workspaceDirectory && workspaceDirectory.ipGroupIds) {
            ...
            for (var workspaceIPGroup of workspaceDirectory.ipGroupIds) {
              var ipGroup = listIPGroups.find(
                (o) => o.groupId === workspaceIPGroup
              );
