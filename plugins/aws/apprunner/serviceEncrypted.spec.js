...
const listServices = [
  {
    ...
    ServiceArn:
      "arn:aws:apprunner:us-east-1:000111222333:service/sadeed1/9110332340cc4be5963e467f5deae770",
    ...
    Service: {
      ...
      SourceConfiguration: {
        ...
        AuthenticationConfiguration: {
          ConnectionArn:
            "arn:aws:apprunner:us-east-1:000011112222:connection/apprunner-connection/5497e544592748d29d92b57252d791b0",
        },
      },
      ...
      AutoScalingConfigurationSummary: {
        AutoScalingConfigurationArn:
          "arn:aws:apprunner:us-east-1:000011112222:autoscalingconfiguration/DefaultConfiguration/1/00000000000000000000000000000001",
...
describe("serviceEncrypted", function () {
  describe("run", function () {
    it("should PASS if App Runner service is encrypted with desired encryption level", function (done) {
      ...
      serviceEncrypted.run(
        cache,
        { app_runner_service_desired_encryption_level: "awscmk" },
        (err, results) => {
    ...
    it("should UNKNOWN if unable to list KMS keys", function (done) {
      const cache = createCache(listServices, null, null, null, {
