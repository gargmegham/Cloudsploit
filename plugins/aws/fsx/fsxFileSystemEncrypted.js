  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      desiredEncryptionLevelString:
        settings.fsx_file_systems_encryption_level ||
        this.settings.fsx_file_systems_encryption_level.default,
    };
      ...
      function (region, rcb) {
        ...
        if (listFileSystems.err || !listFileSystems.data) {
          helpers.addResult(
            results,
            3,
            `Unable to query FSx file systems: ${helpers.addError(
              listFileSystems
            )}`,
            region
          );
        ...
        for (let fileSystem of listFileSystems.data) {
          if (
            ...
            fileSystem.FileSystemType.toLowerCase() !== "windows"
          ) {
            continue;
          }
