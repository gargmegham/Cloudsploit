...
const domains = [
  {
    DomainStatus: {
      ...
      AccessPolicies:
        '{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Principal":{"AWS":"*"},"Action":"es:*","Resource":"arn:aws:es:us-east-1:1123456654321:domain/test-domain-104/*"}]}',
      SnapshotOptions: {},
      VPCOptions: {
        VPCId: "vpc-99de2fe4",
        SubnetIds: ["subnet-c21b84cc"],
        AvailabilityZones: ["us-east-1f"],
        SecurityGroupIds: ["sg-047e6cc36b13ec60e"],
      },
      CognitoOptions: {
        Enabled: false,
      },
  ...
  },
  {
    DomainStatus: {
      ...
      Deleted: false,
      Endpoint:
        "search-test-domain3-104-oqrea5hh2cok7twvowby43f3iy.us-east-1.es.amazonaws.com",
      Processing: false,
      UpgradeProcessing: false,
      ElasticsearchVersion: "7.7",
      ElasticsearchClusterConfig: {
  ...
  },
  {
    DomainStatus: {
      ...
      AccessPolicies:
        '{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Principal":{"AWS":"arn:aws:iam::1123456654321:role/service-role/AmazonComprehendServiceRole-akhtar-comprehend-role"},"Action":"es:*","Resource":"arn:aws:es:us-east-1:1123456654321:domain/test-domain2-104/*"}]}',
      SnapshotOptions: {},
      VPCOptions: {
        VPCId: "vpc-99de2fe4",
        SubnetIds: ["subnet-6a8b635b"],
        AvailabilityZones: ["us-east-1e"],
        SecurityGroupIds: ["sg-001639e564442dfec"],
      },
      CognitoOptions: {
        Enabled: false,
      },
