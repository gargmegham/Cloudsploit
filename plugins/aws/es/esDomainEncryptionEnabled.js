  ...
  run: function (cache, settings, callback) {
    var config = {
      desiredEncryptionLevelString:
        settings.es_encryption_level ||
        this.settings.es_encryption_level.default,
    };
        ...
        listDomainNames.data.forEach((domain) => {
          ...
          if (
            ...
            if (
              ...
              var kmsKeyId =
                describeElasticsearchDomain.data.DomainStatus.EncryptionAtRestOptions.KmsKeyId.split(
                  "/"
                )[1];
              ...
              helpers.addResult(
                results,
                2,
                "ES domain is not configured to use encryption at rest",
                region,
                resource
              );
            }
