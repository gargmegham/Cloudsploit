...
describe("esDesiredInstanceTypes", function () {
  describe("run", function () {
    it("should FAIL if dedicated master and data node are not of desired instance type", function (done) {
      ...
      esDesiredInstanceTypes.run(
        cache,
        {
          es_desired_data_instance_type: "t2.medium.elasticsearch",
          es_desired_master_instance_type: "t2.medium.elasticsearch",
        },
        (err, results) => {
    ...
    it("should PASS if master and data instances re of desired instance types", function (done) {
      ...
      esDesiredInstanceTypes.run(
        cache,
        {
          es_desired_data_instance_type: "t2.small.elasticsearch",
          es_desired_master_instance_type: "t2.small.elasticsearch",
        },
        (err, results) => {
          expect(results.length).to.equal(1);
