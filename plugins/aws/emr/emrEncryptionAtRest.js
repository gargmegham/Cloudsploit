          ...
          function (cluster, lcb) {
            ...
            if (!describeCluster.data.Cluster.SecurityConfiguration) {
              helpers.addResult(
                results,
                2,
                "No security configuration found for :" +
                  cluster.Name +
                  ": EMR cluster",
                region,
                resource
            ...
            var securityConfigurationName =
              describeCluster.data.Cluster.SecurityConfiguration;

            var describeSecurityConfiguration = helpers.addSource(
              cache,
              source,
              [
                "emr",
            ...
            if (
              ...
              helpers.addResult(
                results,
                3,
                "Unable to query for EMR cluster security configuration",
                region,
                resource
              );
              return lcb();
            ...
            try {
              var clusterSecurityConfiguration = JSON.parse(
                describeSecurityConfiguration.data.SecurityConfiguration
              );
            } catch (e) {
              helpers.addResult(
            ...
            if (
              clusterSecurityConfiguration.EncryptionConfiguration &&
              clusterSecurityConfiguration.EncryptionConfiguration
              ...
              clusterSecurityConfiguration.EncryptionConfiguration
                .AtRestEncryptionConfiguration.LocalDiskEncryptionConfiguration
            ) {
              helpers.addResult(
                results,
                0,
                "Encryption at rest for local disks is enabled for :" +
                  cluster.Name +
                  ": EMR cluster",
                region,
                resource
              ...
              helpers.addResult(
                results,
                2,
                "Encryption at rest for local disks is not enabled for :" +
                  cluster.Name +
                  ": EMR cluster",
                region,
                resource
