...
const listClusters = [
  {
    ...
    ClusterArn:
      "arn:aws:elasticmapreduce:us-east-1:000011112222:cluster/j-2C3R1T3QB6HBQ",
  },
  {
    Id: "j-2GWDFSLQDWY54",
    Name: "My cluster12",
    Status: {
      ...
      StateChangeReason: {
        ...
        Message:
          "On the master instance (i-07434010850e76576), application provisioning failed",
      },
      Timeline: {
    ...
    NormalizedInstanceHours: 0,
    ClusterArn:
      "arn:aws:elasticmapreduce:us-east-1:000011112222:cluster/j-2GWDFSLQDWY54",
  },
];
...
describe("emrDesiredInstanceType", function () {
  describe("run", function () {
    it("should FAIL if master and core are not of desired instance type", function (done) {
      ...
      emrDesiredInstanceType.run(
        cache,
        {
          emr_desired_master_instance_type: "c1.medium",
          emr_desired_core_instance_type: "c1.medium",
        },
        (err, results) => {
