...
const listClusters = [
  {
    ...
    ClusterArn:
      "arn:aws:elasticmapreduce:us-east-1:123456654321:cluster/j-BH72QI9T25CL",
  },
  {
    Id: "j-2FO4W2DL7JJAM",
    Name: "My cluster",
    Status: {
      ...
      StateChangeReason: {
        ...
        Message:
          "On the master instance (i-0ddd5cacbc6b0082c), application provisioning timed out",
      },
      Timeline: {
    ...
    NormalizedInstanceHours: 0,
    ClusterArn:
      "arn:aws:elasticmapreduce:us-east-1:123456654321:cluster/j-2FO4W2DL7JJAM",
  },
  {
    Id: "j-3MTKFUU3FOIOD",
    ...
    Status: {
      ...
      StateChangeReason: {
        Code: "BOOTSTRAP_FAILURE",
        Message:
          "On the master instance (i-0b72f161549b8dbe0), application provisioning failed",
      },
      Timeline: {
    ...
    NormalizedInstanceHours: 0,
    ClusterArn:
      "arn:aws:elasticmapreduce:us-east-1:123456654321:cluster/j-3MTKFUU3FOIOD",
  },
  {
    Id: "j-2RF0ACE2SIAWT",
    Name: "My cluster",
    Status: {
      ...
      StateChangeReason: {
        ...
        Message:
          "On the master instance (i-07c57ec89814ff6fb), Invalid S3Provider: Cannot recognize cacert.pem from the S3Provider zip file.",
      },
      Timeline: {
    ...
    NormalizedInstanceHours: 0,
    ClusterArn:
      "arn:aws:elasticmapreduce:us-east-1:123456654321:cluster/j-2RF0ACE2SIAWT",
  },
];
...
const describeSecurityConfiguration = [
  {
    ...
    SecurityConfiguration:
      '{"EncryptionConfiguration":{"AtRestEncryptionConfiguration":{"LocalDiskEncryptionConfiguration":{"EncryptionKeyProviderType":"AwsKms","AwsKmsKey":"arn:aws:kms:us-east-1:123456654321:alias/test138","EnableEbsEncryption":true}},"EnableInTransitEncryption":false,"EnableAtRestEncryption":true}}',
    CreationDateTime: "2020-09-17T09:39:01.657Z",
  },
  {
    Name: "test-security-100",
    SecurityConfiguration:
      '{"EncryptionConfiguration":{"AtRestEncryptionConfiguration":{"S3EncryptionConfiguration":{"EncryptionMode":"SSE-S3"}},"EnableInTransitEncryption":false,"EnableAtRestEncryption":true}}',
    CreationDateTime: "2020-09-08T11:34:44.884Z",
  },
  {
    Name: "test-sc-100",
    SecurityConfiguration:
      '{"EncryptionConfiguration":{"InTransitEncryptionConfiguration":{"TLSCertificateConfiguration":{"CertificateProviderType":"PEM","S3Object":"s3://test-bucket-sploit-100/cacert.zip"}},"AtRestEncryptionConfiguration":{"S3EncryptionConfiguration":{"EncryptionMode":"SSE-S3"}},"EnableInTransitEncryption":true,"EnableAtRestEncryption":true}}',
...
const createCache = (
  ...
  var clusterId =
    listClusters && listClusters.length ? listClusters[0].Id : null;
  var securtiyConfigurationName =
    describeCluster &&
    describeCluster.Cluster &&
    describeCluster.Cluster.SecurityConfiguration
      ? describeCluster.Cluster.SecurityConfiguration
      : null;
  ...
  describe("run", function () {
    it("should FAIL if encryption at rest for local disks is not enabled for EMR cluster", function (done) {
      const cache = createCache(
        [listClusters[1]],
        describeCluster[0],
        describeSecurityConfiguration[1]
      );
    ...
    it("should PASS if encryption at rest for local disks is enabled for EMR cluster", function (done) {
      const cache = createCache(
        [listClusters[0]],
        describeCluster[2],
        describeSecurityConfiguration[0]
      );
      emrEncryptionAtRest.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
