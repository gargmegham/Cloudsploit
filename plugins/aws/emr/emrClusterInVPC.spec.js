...
const listClusters = [
  {
    ...
    Status: {
      ...
      StateChangeReason: {
        ...
        Message:
          "The requested instance type c1.medium is not supported in the requested availability zone. Learn more at https://docs.aws.amazon.com/console/elasticmapreduce/ERROR_noinstancetype",
      },
      Timeline: {
    ...
    ClusterArn:
      "arn:aws:elasticmapreduce:us-east-1:000011112222:cluster/j-8PNQXHQF599L",
  },
  {
    Id: "j-11W10W1AXKL60",
    Name: "MyCluster8",
    Status: {
      ...
      StateChangeReason: {
        Code: "VALIDATION_ERROR",
        Message:
          "The requested instance type m1.large is not supported in the requested availability zone. Learn more at https://docs.aws.amazon.com/console/elasticmapreduce/ERROR_noinstancetype",
      },
    },
  },
];
...
const describeCluster = [
  {
    Cluster: {
      ...
      Ec2InstanceAttributes: {
        ...
        RequestedEc2SubnetIds: ["subnet-0970477bd56d55b76"],
