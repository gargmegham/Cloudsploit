...
const listDomains = [
  {
    ...
    ServerSideEncryptionConfiguration: {
      KmsKeyId:
        "arn:aws:kms:us-east-1:112222333:key/ad013a33-b01d-4d88-ac97-127399c18b3e",
    },
  ...
  },
  {
    ...
    ServerSideEncryptionConfiguration: {
      KmsKeyId:
        "arn:aws:kms:us-east-1:112233:key/ad013a33-b01d-4d88-ac97-127399c18b3e",
    },
  ...
  },
  {
    ...
    ServerSideEncryptionConfiguration: {
      KmsKeyId:
        "arn:aws:kms:us-east-1:1122233:key/ad013a33-b01d-4d88-ac97-127399c18b3e",
    },
...
describe("voiceIdDomainEncrypted", function () {
  describe("run", function () {
    it("should PASS if VoiceID domain is encrypted with desired encryption level", function (done) {
      ...
      voiceIdDomainEncrypted.run(
        cache,
        { voice_id_desired_encryption_level: "awscmk" },
        (err, results) => {
