  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      desiredEncryptionLevelString:
        settings.wisdom_desired_encryption_level ||
        this.settings.wisdom_desired_encryption_level.default,
    };
      ...
      function (region, rcb) {
        ...
        if (listDomains.err || !listDomains.data) {
          helpers.addResult(
            results,
            3,
            "Unable to query Connect Wisdom domains: " +
        ...
        if (!listDomains.data.length) {
          helpers.addResult(
            results,
            0,
            "No Connect Wisdom domains found",
            region
          );
          return rcb();
        }
