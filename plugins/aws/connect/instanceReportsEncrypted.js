...
module.exports = {
  ...
  apis: [
    ...
    "Connect:listInstanceExportedReportStorageConfigs",
    "KMS:listKeys",
    "KMS:describeKey",
  ],
  settings: {
  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      desiredEncryptionLevelString:
        settings.connect_exported_reports_encryption_level ||
        this.settings.connect_exported_reports_encryption_level.default,
    };
    ...
    async.each(
      ...
      function (region, rcb) {
        ...
        for (let instance of listInstances.data) {
          ...
          var listInstanceExportedReportStorageConfigs = helpers.addSource(
            cache,
            source,
            [
              "connect",
          ...
          if (
            !listInstanceExportedReportStorageConfigs ||
            listInstanceExportedReportStorageConfigs.err ||
            !listInstanceExportedReportStorageConfigs.data ||
            !listInstanceExportedReportStorageConfigs.data.StorageConfigs
          ) {
            helpers.addResult(
              results,
              3,
              `Unable to describe Connect instance exported reports storage config: ${helpers.addError(
                listInstanceExportedReportStorageConfigs
              )}`,
              region,
              resource
          ...
          if (
            !listInstanceExportedReportStorageConfigs.data.StorageConfigs.length
          ) {
            helpers.addResult(
              results,
              0,
          ...
          let storageConfig =
            listInstanceExportedReportStorageConfigs.data.StorageConfigs[0];
