...
const listAssistants = [
  {
    assistantArn:
      "arn:aws:wisdom:us-east-1:111122223333:assistant/6abcbdde-4a11-42b1-a79c-18e1e7d554c3",
  ...
  },
  {
    ...
    serverSideEncryptionConfiguration: {
      kmsKeyId:
        "arn:aws:kms:us-east-1:111122223333:key/22322a33-b01d-4d88-ac97-127399c18b3e",
    },
    status: "ACTIVE",
    tags: {},
    type: "AGENT",
  ...
  {
    assistantArn:
      "arn:aws:wisdom:us-east-1:111122223333:assistant/e5b466a7-52e6-480d-a145-965ba1882c18",
...
describe("wisdomDomainEncrypted", function () {
  describe("run", function () {
    it("should PASS if Wisdom domain is encrypted with desired encryption level", function (done) {
      ...
      wisdomDomainEncrypted.run(
        cache,
        { wisdom_desired_encryption_level: "awscmk" },
        (err, results) => {
