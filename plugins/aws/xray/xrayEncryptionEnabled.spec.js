...
var getEncryptionConfig = [
  {
    KeyId:
      "arn:aws:kms:us-east-1:111122223333:key/a7c4862e-02e6-4a21-b0be-f2db95d6cf43",
    Status: "ACTIVE",
    Type: "KMS",
  },
];
...
describe("xrayEncryptionEnabled", function () {
  describe("run", function () {
    it("should FAIL if current encryption level is less than desired encryption level", function (done) {
      ...
      xrayEncryptionEnabled.run(
        cache,
        { xray_encryption_level: "awscmk" },
        (err, results) => {
