          ...
          destination: {
            cloudWatch: {
              cloudWatchLogGroupArn:
                "arn:aws:logs:us-east-1:000011112222:log-group:mine1",
...
const createCache = (
  ...
  var botAliasId =
    listBotAliases && listBotAliases.length
      ? listBotAliases[0].botAliasId
      : null;
  return {
    lexmodelsv2: {
      listBots: {
...
describe("lexAudioLogsEncrypted", function () {
  describe("run", function () {
    ...
    it("should UNKNOWN if unable to list KMS keys", function (done) {
      const cache = createCache([listBots[0]], null, null, null, null, {
