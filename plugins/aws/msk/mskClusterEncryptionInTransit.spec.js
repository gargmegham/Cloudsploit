...
const listClusters = [
  {
    ClusterArn:
      "arn:aws:kafka:us-east-1:000111222333:cluster/sad/3dce8c4f-76a7-4b74-b1ec-192dec1a750b-20",
    ClusterName: "test",
    ...
    EncryptionInfo: {
      EncryptionAtRest: {
        DataVolumeKMSKeyId:
          "arn:aws:kms:us-east-1:000111222333:key/39009d78-b364-4a0b-937f-c89a2c2b473f",
      },
      EncryptionInTransit: {
  ...
  {
    ClusterArn:
      "arn:aws:kafka:us-east-1:000111222333:cluster/sadeed/d54ff036-fbce-4272-a3f2-3b50ecb66d57-20",
    ClusterName: "sadeed",
    ClusterName: "test1",
