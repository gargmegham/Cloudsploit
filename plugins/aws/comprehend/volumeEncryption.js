        ...
        async.parallel(
          [
            function (lcb) {
              ...
              if (
                listEntitiesDetectionJobs.err ||
                !listEntitiesDetectionJobs.data
              ) {
                helpers.addResult(
                  results,
                  3,
                  "Unable to query for entities detections jobs",
                  region
                );
                return lcb();
              }
              ...
              if (!listEntitiesDetectionJobs.data.length) {
                helpers.addResult(
                  results,
                  0,
                  "No entities detection jobs found",
                  region
                );
                return lcb();
              }
            ...
            function (lcb) {
              var listDocumentClassificationJobs = helpers.addSource(
                cache,
                source,
              ...
              if (
                listDocumentClassificationJobs.err ||
                !listDocumentClassificationJobs.data
              ) {
                helpers.addResult(
                  results,
                  3,
                  "Unable to query for document classification jobs",
                  region
                );
                return lcb();
              }
              ...
              if (!listDocumentClassificationJobs.data.length) {
                helpers.addResult(
                  results,
                  0,
                  "No document classification jobs found",
                  region
                );
                return lcb();
              }
            ...
            function (lcb) {
              var listDominantLanguageDetectionJobs = helpers.addSource(
                cache,
                source,
              ...
              if (
                listDominantLanguageDetectionJobs.err ||
                !listDominantLanguageDetectionJobs.data
              ) {
                helpers.addResult(
                  results,
                  3,
                  "Unable to query for dominant language detection jobs",
                  region
                );
                return lcb();
              }
              ...
              if (!listDominantLanguageDetectionJobs.data.length) {
                helpers.addResult(
                  results,
                  0,
                  "No dominant language detection jobs found",
                  region
                );
                return lcb();
              }
            ...
            function (lcb) {
              ...
              if (
                listTopicsDetectionJobs.err ||
                !listTopicsDetectionJobs.data
              ) {
                helpers.addResult(
                  results,
                  3,
                  "Unable to query for topics detection jobs",
                  region
                );
                return lcb();
              }
              ...
              if (!listTopicsDetectionJobs.data.length) {
                helpers.addResult(
                  results,
                  0,
                  "No topics detection jobs found",
                  region
                );
                return lcb();
              }
            ...
            function (lcb) {
              var listKeyPhrasesDetectionJobs = helpers.addSource(
                cache,
                source,
              ...
              if (
                listKeyPhrasesDetectionJobs.err ||
                !listKeyPhrasesDetectionJobs.data
              ) {
                helpers.addResult(
                  results,
                  3,
                  "Unable to query for key phrases detection jobs",
                  region
                );
                return lcb();
              }
              ...
              if (!listKeyPhrasesDetectionJobs.data.length) {
                helpers.addResult(
                  results,
                  0,
                  "No key phrases detection jobs found",
                  region
                );
                return lcb();
              }
            ...
            function (lcb) {
              var listSentimentDetectionJobs = helpers.addSource(
                cache,
                source,
              ...
              if (
                listSentimentDetectionJobs.err ||
                !listSentimentDetectionJobs.data
              ) {
                helpers.addResult(
                  results,
                  3,
                  "Unable to query for sentiment detection jobs",
                  region
                );
                return lcb();
              }
              ...
              if (!listSentimentDetectionJobs.data.length) {
                helpers.addResult(
                  results,
                  0,
                  "No sentiment detection jobs found",
                  region
                );
                return lcb();
              }
