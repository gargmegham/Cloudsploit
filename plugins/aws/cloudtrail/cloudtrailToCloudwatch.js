      ...
      function (region, rcb) {
        ...
        if (describeTrails.err || !describeTrails.data) {
          helpers.addResult(
            results,
            3,
            "Unable to query for CloudTrail CloudWatch integration status: " +
          ...
          for (var t in describeTrails.data) {
            ...
            if (!describeTrails.data[t].CloudWatchLogsLogGroupArn) {
              helpers.addResult(
                results,
                2,
                "CloudTrail CloudWatch integration is not enabled",
                region,
              ...
              helpers.addResult(
                results,
                0,
                "CloudTrail CloudWatch integration is enabled",
                region,
                describeTrails.data[t].TrailARN
              );
            }
