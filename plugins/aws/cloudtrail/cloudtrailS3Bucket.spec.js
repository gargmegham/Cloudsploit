...
const describeTrails = [
  {
    ...
    TrailARN:
      "arn:aws:cloudtrail:us-east-1:111122223333:trail/management-events",
...
describe("cloudtrailS3Bucket", function () {
  describe("run", function () {
    it("should PASS if CloudTrail trail has correct S3 bucket configured", function (done) {
      ...
      cloudtrailS3Bucket.run(
        cache,
        { trail_s3_bucket_name: "aws-cloudtrail-logs-119d2f9a" },
        (err, results) => {
    ...
    it("should PASS if CloudTrail trail is set to pass without checking S3 bucket name", function (done) {
      ...
      cloudtrailS3Bucket.run(
        cache,
        {
          trail_s3_bucket_name: "sample-bucket-123",
          trails_to_check: "trail-1",
        },
        (err, results) => {
