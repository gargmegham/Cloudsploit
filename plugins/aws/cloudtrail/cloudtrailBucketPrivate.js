  ...
  run: function (cache, settings, callback) {
    var config = {
      whitelist_ct_private_buckets:
        ...
        this.settings.whitelist_ct_private_buckets.default,
    };
    var regBucket;
    if (config.whitelist_ct_private_buckets.length)
      regBucket = new RegExp(config.whitelist_ct_private_buckets);
    var results = [];
    var source = {};
        ...
        async.each(
          ...
          function (trail, cb) {
            ...
            for (var i in getBucketAcl.data.Grants) {
              if (
                getBucketAcl.data.Grants[i].Grantee.Type &&
                ...
                allowsAllUsersTypes.push(
                  getBucketAcl.data.Grants[i].Permission
                );
              }
            }
