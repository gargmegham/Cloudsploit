...
module.exports = {
  ...
  more_info:
    "Using the latest generation of Amazon ElastiCache instances instances will benefit clusters for higher hardware performance, " +
          ...
          if (cluster.CacheNodeType) {
            ...
            if (previousGen.includes(generation)) {
              helpers.addResult(
                results,
                2,
                "ElastiCache cluster is running previoud generation instance node: " +
                  generation,
                region,
                resource
              );
              ...
              helpers.addResult(
                results,
                0,
                "ElastiCache cluster is running current generation Instance Node: " +
                  generation,
                region,
                resource
              );
