...
const getBucketPolicy = [
  {
    Policy:
      '{"Version":"2008-10-17","Id":"PolicyForCloudFrontPrivateContent","Statement":[{"Sid":"1","Effect":"Allow","Principal":{"AWS":"arn:aws:iam::cloudfront:user/CloudFront Origin Access Identity E1GFXAXB2CIBLG"},"Action":"s3:GetObject","Resource":"arn:aws:s3:::my.bucket.akhtar/*"}]}',
  },
  {
    Policy:
      '{"Version":"2008-10-17","Id":"PolicyForCloudFrontPrivateContent","Statement":[{"Sid":"1","Effect":"Allow","Principal":{"AWS":"arn:aws:iam::000011112222:root"},"Action":"s3:GetObject","Resource":"arn:aws:s3:::my.bucket.akhtar/*"}]}',
  },
  {
    Policy: null,
  },
      ...
      Items: [
        {
          ...
          S3OriginConfig: {
            OriginAccessIdentity:
              "origin-access-identity/cloudfront/E1GFXAXB2CIBLG",
          },
...
const createCache = (
  ...
  var bucketName =
    listBuckets && listBuckets.length ? listBuckets[0].Name : null;
  return {
    s3: {
      listBuckets: {
        "us-east-1": {
...
describe("bucketPolicyCloudFrontOai", function () {
  describe("run", function () {
    ...
    it("should FAIL if S3 bucket is origin to more than one distributions", function (done) {
      const cache = createCache(
        [listDistributions[2], listDistributions[3]],
        [listBuckets[1]]
      );
      bucketPolicyCloudFrontOai.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
