...
module.exports = {
  ...
  more_info:
    "Object versioning can help protect against the overwriting of \
                objects or data loss in the event of a compromise.",
  recommended_action:
    "Enable object versioning for buckets with \
  ...
  remediation_description:
    "The impacted bucket will be configured to be have Versioning enabled.",
  ...
  remediate: function (config, cache, settings, resource, callback) {
    ...
    if (
      !bucketLocations ||
      bucketLocations.err ||
      !Object.keys(bucketLocations).length
    ) {
