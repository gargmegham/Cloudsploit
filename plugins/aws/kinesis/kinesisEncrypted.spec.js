      ...
      Shards: [
        {
          ...
          SequenceNumberRange: {
            StartingSequenceNumber:
              "49625248393108116739567127156011434883828455224553504770",
          },
        },
      ],
      ...
      Shards: [
        {
          ...
          SequenceNumberRange: {
            StartingSequenceNumber:
              "49625248607195270645461109314754330301252766913651539970",
          },
        },
      ],
  ...
  describe("run", function () {
    ...
    it("should UNKNOWN if unable to list Kinesis streams", function (done) {
      const cache = createCache(null, null, {
        message: "Unable to list Kinesis streams",
      });
      kinesisEncrypted.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
