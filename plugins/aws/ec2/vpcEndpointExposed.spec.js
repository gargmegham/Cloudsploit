...
const vpcEndpoints = [
  {
    ...
    State: "available",
    PolicyDocument:
      '{"Version":"2008-10-17","Statement":[{"Effect":"Deny","Principal":"*","Action":"*","Resource":"*"}]}',
    RouteTableIds: [],
    SubnetIds: [],
    Groups: [],
  ...
  },
  {
    ...
    PolicyDocument:
      '{\n    "Statement": [\n        {\n            "Action": "*",\n            "Effect": "Allow",\n            "Resource": "*",\n            "Principal": "*"\n        }\n    ]\n}',
    RouteTableIds: [],
    SubnetIds: ["subnet-6a8b635b", "subnet-c21b84cc", "subnet-aac6b3e7"],
    Groups: [
      {
        GroupId: "sg-aa941691",
        GroupName: "default",
    ...
    RequesterManaged: false,
    NetworkInterfaceIds: ["eni-0d830573a71f0adf3", "eni-091313ac29683c395"],
