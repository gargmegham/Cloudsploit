...
module.exports = {
  ...
  compliance: {
    hipaa:
      "HIPAA data should not be stored on EC2 AMIs. However, if data is " +
      ...
      function (region, rcb) {
        ...
        if (unencryptedAmis.length > 20) {
          helpers.addResult(
            results,
            2,
            "More than 20 unencrypted AMI EBS volumes found",
            region
          );
          ...
          helpers.addResult(
            results,
            0,
            "No AMIs with unencrypted volumes found",
            region
          );
        }
