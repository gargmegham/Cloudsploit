...
module.exports = {
  ...
  settings: {
    instance_iam_role_threshold: {
      ...
      description:
        "If more than this number of instances are missing an IAM role, results will be collapsed into a single result to avoid excessive result counts. Max is 299.",
      regex: "^[1-2]{1}[0-9]{0,2}$",
      default: 10,
    },
  },
  ...
  run: function (cache, settings, callback) {
    var config = {
      instance_iam_role_threshold:
        settings.instance_iam_role_threshold ||
        this.settings.instance_iam_role_threshold.default,
    };
      ...
      function (region, rcb) {
        ...
        if (found > config.instance_iam_role_threshold) {
          ...
          helpers.addResult(
            ...
            2,
            "Over " +
              config.instance_iam_role_threshold +
              " EC2 instances do not use an IAM role",
            region,
            null,
            custom
          );
