...
const describeLaunchConfigurations = [
  {
    ...
    LaunchConfigurationARN:
      "arn:aws:autoscaling:us-east-1:111122223333:launchConfiguration:79298288-6ac0-4031-bf3c-05aa13c64bbc:launchConfigurationName/test-32",
    ImageId: "ami-026c295331eb10e50",
    KeyName: "auto-scaling-test-instance",
    SecurityGroups: ["sg-099a21ef57db4bad1"],
    ...
    IamInstanceProfile:
      "arn:aws:iam::111122223333:instance-profile/EMR_EC2_DefaultRole",
    ...
    LaunchTemplateVersions: [
      {
        ...
        LaunchTemplateData: {
          ...
          SecurityGroupIds: ["sg-043778823f73431a7", "sg-02e2c70cd463dca29"],
          SecurityGroups: [],
  ...
  describe("run", function () {
    it("should PASS if Amazon Machine Image is in use", function (done) {
      const cache = createCache(
        ...
        [describeLaunchTemplates[0]],
        describeLaunchTemplateVersions[0]
      );
