...
const getLifecyclePolicy = [
  {
    Policy: {
      ...
      ExecutionRoleArn:
        "arn:aws:iam::112233445566:role/service-role/AWSDataLifecycleManagerDefaultRole",
      ...
      PolicyArn:
        "arn:aws:dlm:us-east-1:112233445566:policy/policy-061754468570a2ed1",
    },
  },
];
...
const createCache = (
  ...
  var policyId =
    getLifecyclePolicies && getLifecyclePolicies.length
      ? getLifecyclePolicies[0].PolicyId
      : null;
  return {
    ec2: {
      describeVolumes: {
