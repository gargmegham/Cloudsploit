...
module.exports = {
  ...
  settings: {
    rds_multi_az_ignore_replicas: {
      ...
      description:
        "When set to true, RDS read replicas which does not require multi-AZ configuration will PASS",
      regex: "^(true|false)$",
      default: "false",
    },
  },
  ...
  run: function (cache, settings, callback) {
    var config = {
      rds_multi_az_ignore_replicas:
        settings.rds_multi_az_ignore_replicas ||
        this.settings.rds_multi_az_ignore_replicas.default,
    };

    config.rds_multi_az_ignore_replicas =
      config.rds_multi_az_ignore_replicas == "true";
