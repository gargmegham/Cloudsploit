...
const describeDBInstances = [
  {
    ...
    KmsKeyId:
      "arn:aws:kms:us-east-1:012345678910:key/abcdef10-1517-49d8-b085-77c50b904149",
  ...
  },
  {
    ...
    StorageEncrypted: true,
    KmsKeyId:
      "arn:aws:kms:us-east-1:012345678910:key/88888828-1517-49d8-b085-77c50b904149",
    DbiResourceId: "db-ZLVMKFR7AS6SJYTQPXZ4SUH5ZU",
    CACertificateIdentifier: "rds-ca-2019",
    DomainMemberships: [],
    CopyTagsToSnapshot: false,
  ...
  describe("run", function () {
    ...
    it("should PASS if the db instance is of type docDB", function (done) {
      ...
      rdsRestorable.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
        expect(results[0].status).to.equal(0);
        expect(results[0].message).includes(
          "DocumentDB engine uses incremental backups"
        );
        done();
      });
    });
