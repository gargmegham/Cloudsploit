      ...
      function (group, cb) {
        ...
        if (!getGroup || getGroup.err || !getGroup.data) {
          helpers.addResult(
            results,
            3,
            "Unable to query for group: " +
              group.GroupName +
              ": " +
              helpers.addError(getGroup),
            "global",
            group.Arn
          );
          ...
          helpers.addResult(
            results,
            1,
            "Group: " + group.GroupName + " does not contain any users",
            "global",
            group.Arn
          );
          return cb();
