...
const listRolePolicies = [
  ...
  {
    PolicyNames: ["All-Action-Resources"],
  },
];
...
const getRolePolicy = [
  {
    ...
    PolicyName: "S3-Full",
    PolicyDocument:
      "%7B%0A%20%20%20%20%22Version%22%3A%20%222012-10-17%22%2C%0A%20%20%20%20%22Statement%22%3A%20%5B%0A%20%20%20%20%20%20%20%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Sid%22%3A%20%22VisualEditor0%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Effect%22%3A%20%22Allow%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Action%22%3A%20%22s3%3A%2A%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Resource%22%3A%20%22%2A%22%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%5D%0A%7D",
  },
  {
    RoleName: "test-role-2",
    PolicyName: "S3-WildCard",
    PolicyDocument:
      "%7B%0A%20%20%20%20%22Version%22%3A%20%222012-10-17%22%2C%0A%20%20%20%20%22Statement%22%3A%20%5B%0A%20%20%20%20%20%20%20%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Sid%22%3A%20%22VisualEditor1%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Effect%22%3A%20%22Allow%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Action%22%3A%20%22s3%3Ag%2A%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Resource%22%3A%20%22%2A%22%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%5D%0A%7D",
  },
  {
    RoleName: "test-role-2",
    PolicyName: "S3-Limited",
    PolicyDocument:
      "%7B%0A%20%20%20%20%22Version%22%3A%20%222012-10-17%22%2C%0A%20%20%20%20%22Statement%22%3A%20%5B%0A%20%20%20%20%20%20%20%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Sid%22%3A%20%22VisualEditor1%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Effect%22%3A%20%22Allow%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Action%22%3A%20%22s3%3AGetObject%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Resource%22%3A%20%22%2A%22%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%5D%0A%7D",
  },
  {
    RoleName: "test-role-2",
    PolicyName: "All-Action-Resources",
    PolicyDocument:
      "%7B%0A%20%20%20%20%22Version%22%3A%20%222012-10-17%22%2C%0A%20%20%20%20%22Statement%22%3A%20%5B%0A%20%20%20%20%20%20%20%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Sid%22%3A%20%22VisualEditor1%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Effect%22%3A%20%22Allow%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Action%22%3A%20%22%2A%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Resource%22%3A%20%22%2A%22%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%5D%0A%7D",
  },
  {
    RoleName: "test-role-2",
    PolicyName: "All-Actions",
    PolicyDocument:
      "%7B%0A%20%20%20%20%22Version%22%3A%20%222012-10-17%22%2C%0A%20%20%20%20%22Statement%22%3A%20%5B%0A%20%20%20%20%20%20%20%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Sid%22%3A%20%22VisualEditor1%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Effect%22%3A%20%22Allow%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Action%22%3A%20%22%2A%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22Resource%22%3A%20%22arn%3Aaws%3As3%3A%3A%3A%2A%22%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%5D%0A%7D",
  },
];
...
const createCache = (
  ...
  getPolicyVersion,
  configStatusErr,
  discoveredResourcesErr,
  listRolesErr,
  listRolePoliciesErr,
  listAttachedRolePoliciesErr
) => {
  var roleName = listRoles && listRoles.length ? listRoles[0].RoleName : null;
  var policyArn =
    listAttachedRolePolicies && listAttachedRolePolicies.AttachedPolicies
      ? listAttachedRolePolicies.AttachedPolicies[0].PolicyArn
      : null;
  var policyName =
    listRolePolicies && listRolePolicies.PolicyNames
      ? listRolePolicies.PolicyNames[0]
      : null;
  return {
    configservice: {
  ...
  describe("run", function () {
    ...
    it("should PASS if role policy allows wildcard actions but ignore managed iam policies is set to true", function (done) {
      ...
      rolePolicyUnusedServices.run(
        cache,
        { ignore_customer_managed_iam_policies: "true" },
        (err, results) => {
          expect(results.length).to.equal(1);
          expect(results[0].status).to.equal(0);
          done();
    ...
    it("should UNKNOWN if unable to list attached role policies", function (done) {
      const cache = createCache(
        ...
        null,
        null,
        { message: "Unable to list attached role policies" }
      );
      rolePolicyUnusedServices.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
        expect(results[0].status).to.equal(3);
    ...
    it("should UNKNOWN if unable to list role policies", function (done) {
      const cache = createCache(
        ...
        null,
        null,
        { message: "Unable to query role policies" }
      );
      rolePolicyUnusedServices.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
        expect(results[0].status).to.equal(3);
    ...
    it("should UNKNOWN if no unable to query for Config Service", function (done) {
      const cache = createCache(
        ...
        null,
        null,
        { message: "Unable to query Config Service" }
      );
      rolePolicyUnusedServices.run(cache, {}, (err, results) => {
