...
const listUserPolicies = ["CustomIAMFull", "CustomIAMLimited"];
...
const createCache = (
  ...
  var groupName =
    listGroups && listGroups.length ? listGroups[0].GroupName : null;
  return {
    iam: {
      listUsers: {
        "us-east-1": {
