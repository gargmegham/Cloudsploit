...
const listEventBuses = [
  {
    ...
    Policy:
      '{"Version":"2012-10-17","Statement":[{"Sid":"allow_all_accounts_from_organization_to_put_events","Effect":"Allow","Principal":"*","Action":"events:PutEvents","Resource":"arn:aws:events:us-east-1:000011112222:event-bus/default","Condition":{"StringEquals":{"aws:PrincipalOrgID":"o-lcjto3x5wd"}}}]}',
  },
  {
    Name: "mine1",
    Arn: "arn:aws:events:us-east-1:000011112222:event-bus/mine1",
    Policy:
      '{"Version":"2012-10-17","Statement":[{"Sid":"allow_all_accounts_from_organization_to_put_events","Effect":"Allow","Principal":{"AWS":"000011112222"},"Action":"events:PutEvents","Resource":"arn:aws:events:us-east-1:000011112222:event-bus/mine1","Condition":{"StringEquals":{"aws:PrincipalOrgID":"o-lcjto3x5wd"}}}]}',
  },
  {
    Name: "test-bus",
