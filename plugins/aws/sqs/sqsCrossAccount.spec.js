...
const queueAttributes = [
  {
    Attributes: {
      ...
      DelaySeconds: "0",
      Policy:
        '{"Version":"2008-10-17","Id":"__default_policy_ID","Statement":[{"Sid":"__owner_statement","Effect":"Allow","Principal":"*","Action":"SQS:*","Resource":"arn:aws:sqs:us-east-1:112233445566:test1152"}]}',
  ...
  },
  {
    Attributes: {
      ...
      DelaySeconds: "0",
      Policy:
        '{"Version":"2008-10-17","Id":"__default_policy_ID","Statement":[{"Sid":"__owner_statement","Effect":"Allow","Principal":{"AWS":"arn:aws:iam::112233445566:root"},"Action":"SQS:*","Resource":"arn:aws:sqs:us-east-1:112233445566:test1152.fifo"}]}',
      ReceiveMessageWaitTimeSeconds: "0",
      FifoQueue: "true",
  ...
  },
  {
    Attributes: {
      ...
      DelaySeconds: "0",
      Policy:
        '{"Version":"2008-10-17","Id":"__default_policy_ID","Statement":[{"Sid":"__owner_statement","Effect":"Allow","Principal":{"AWS":"arn:aws:iam::111222333444:root"},"Action":"SQS:*","Resource":"arn:aws:sqs:us-east-1:112233445566:test1152.fifo"}]}',
      ReceiveMessageWaitTimeSeconds: "0",
      FifoQueue: "true",
      ContentBasedDeduplication: "false",
    },
...
describe("sqsCrossAccount", function () {
  describe("run", function () {
    ...
    it("should PASS if SQS queue policy allows cross-account access to organization account and setting is set to true", function (done) {
      ...
      sqsCrossAccount.run(
        cache,
        { sqs_whitelist_aws_organization_accounts: "true" },
        (err, results) => {
          expect(results.length).to.equal(1);
          expect(results[0].status).to.equal(0);
          done();
