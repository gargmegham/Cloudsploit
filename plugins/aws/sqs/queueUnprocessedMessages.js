...
module.exports = {
  ...
  run: function (cache, settings, callback) {
    ...
    var unprocessedLimit =
      settings.unprocessed_messages_limit ||
      this.settings.unprocessed_messages_limit.default;
          ...
          function (queueUrl, cb) {
            ...
            if (
              ...
              helpers.addResult(
                results,
                3,
                `Unable to query queue attributes: ${helpers.addError(
                  getQueueAttributes
                )}`,
                region,
                resource
            ...
            if (!getQueueAttributes.data.Attributes.ApproximateNumberOfMessages)
              return cb();

            var unprocessedMessages =
              getQueueAttributes.data.Attributes.ApproximateNumberOfMessages;
