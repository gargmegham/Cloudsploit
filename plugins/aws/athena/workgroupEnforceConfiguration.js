        ...
        listWorkGroups.data.forEach(function (wg) {
          ...
          if (!getWorkGroup || getWorkGroup.err || !getWorkGroup.data) {
            ...
            helpers.addResult(
              results,
              0,
              "Athena workgroup is enforcing configuration options",
              region,
              arn
            );
          } else {
            ...
            if (
              ...
              helpers.addResult(
                results,
                0,
                "Athena primary workgroup is not enforcing configuration options but is not in use",
                region,
                arn
              );
            } else {
              helpers.addResult(
                results,
                2,
                "Athena workgroup is not enforcing configuration options",
                region,
                arn
              );
            }
