      ...
      function (region, rcb) {
        ...
        if (describeClusters.err || !describeClusters.data) {
          helpers.addResult(
            results,
            3,
            "Unable to query for DAX clusters: " +
        ...
        for (var c in describeClusters.data) {
          ...
          if (
            ...
            helpers.addResult(
              results,
              0,
              "Encryption is enabled for DAX :" + cluster.ClusterName,
              region,
              resource
            );
          } else {
            helpers.addResult(
              results,
              2,
              "Encryption is not enabled for DAX :" + cluster.ClusterName,
              region,
              resource
            );
          }
