...
const listDeliveryStreams = ["KDS-S3-VzT52"];
...
const describeDeliveryStream = [
  {
    DeliveryStreamDescription: {
      ...
      DeliveryStreamARN:
        "arn:aws:firehose:us-east-1:111122223333:deliverystream/KDS-S3-VzT52",
      ...
      Destinations: [
        {
          ...
          S3DestinationDescription: {
            RoleARN:
              "arn:aws:iam::111122223333:role/service-role/KinesisFirehoseServiceRole-KDS-S3-VzT52-us-east-1-1640617752463",
      ...
      Destinations: [
        {
          ...
          ExtendedS3DestinationDescription: {
            ...
            EncryptionConfiguration: {
              KMSEncryptionConfig:
                "arn:aws:kms:us-east-1:111122223333:key/ad013a33-b01d-4d88-ac97-127399c18b3e",
            },
            CloudWatchLoggingOptions: {
              Enabled: true,
              LogGroupName: "/aws/kinesisfirehose/KDS-S3-VzT52",
...
describe("firehoseEncrypted", function () {
  describe("run", function () {
    ...
    it("should UNKNOWN if unable to query Firehose for delivery streams", function (done) {
      const cache = createCache([listDeliveryStreams[0]], null, null, {
        message: "Unable to Unable to query Firehose for delivery streams",
      });
      firehoseEncrypted.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
        expect(results[0].status).to.equal(3);
