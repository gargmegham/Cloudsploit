...
module.exports = {
  ...
  compliance: {
    hipaa:
      "Firehose encryption must be used when processing any HIPAA-related data. " +
  ...
  run: function (cache, settings, callback) {
    ...
    async.each(
      ...
      function (region, rcb) {
        ...
        async.each(
          listDeliveryStreams.data,
          function (deliverystream, cb) {
            ...
            if (
              ...
              if (
                ...
                helpers.addResult(
                  results,
                  1,
                  "The Firehose delivery stream uses the default KMS key (" +
                    defaultKmsKey +
                    ") for SSE",
                  region,
                  deliveryStreamARN
