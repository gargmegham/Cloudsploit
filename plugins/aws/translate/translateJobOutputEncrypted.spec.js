...
const listTextTranslationJobs = [
  {
    ...
    OutputDataConfig: {
      S3Uri:
        "s3://aquawebsite/data1/000011112222-TranslateText-03c3e7dea26241b22bcbc48624beb75f/",
      EncryptionKey: {
        Type: "KMS",
    ...
    DataAccessRoleArn:
      "arn:aws:iam::000011112222:role/service-role/AmazonTranslateServiceRole-translate",
  },
  {
    JobId: "03c3e7dea26241b22bcbc48624beb75f",
    JobName: "aqua-job1",
  ...
  describe("run", function () {
    ...
    it("should UNKNOWN if unable to list Translate jobs", function (done) {
      const cache = createCache(null, null, null, {
        message: "Unable to list Translate jobs",
      });
      translateJobOutputEncrypted.run(cache, {}, (err, results) => {
        expect(results.length).to.equal(1);
    ...
    it("should UNKNOWN if unable to list KMS keys", function (done) {
      const cache = createCache(listTextTranslationJobs, null, null, null, {
