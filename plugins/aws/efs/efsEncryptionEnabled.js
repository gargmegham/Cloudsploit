...
module.exports = {
  ...
  recommended_action:
    "Encryption of data at rest can only be enabled during file system creation. Encryption of data in transit is configured when mounting your file system. 1. Backup your data in not encrypted efs 2. Recreate the EFS and select 'Enable encryption of data at rest'",
  ...
  compliance: {
    ...
    pci:
      "PCI requires proper encryption of cardholder data at rest. EFS " +
      ...
      function (region, rcb) {
        ...
        if (unencryptedEFS.length > 20) {
          helpers.addResult(
            results,
            2,
            "More than 20 EFS systems are unencrypted",
            region
          );
          ...
          for (var u in unencryptedEFS) {
            ...
            var arn =
              ...
              region +
              ":" +
              unencryptedEFS[u].OwnerId +
              ":file-system/" +
              unencryptedEFS[u].FileSystemId;
            helpers.addResult(
              results,
              2,
              "EFS: " + unencryptedEFS[u].FileSystemId + " is unencrypted",
              region,
              arn
            );
          }
          ...
          helpers.addResult(
            results,
            0,
            "No unencrypted file systems found",
            region
          );
        }
