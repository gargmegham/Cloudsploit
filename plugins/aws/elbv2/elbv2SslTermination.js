          ...
          function (elb, cb) {
            ...
            if (
              ...
              helpers.addResult(
                results,
                3,
                `Unable to query for Load Balancer listeners: ${helpers.addError(
                  describeListeners
                )}`,
                region,
                resource
            ...
            let found = !!describeListeners.data.Listeners.find(
              (listener) =>
                listener.Certificates && listener.Certificates.length
            );
