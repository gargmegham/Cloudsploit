...
module.exports = {
  ...
  description:
    "Ensures ELBs are configured to only accept" +
    " connections on HTTPS ports.",
  more_info:
    "For maximum security, ELBs can be configured to only" +
  ...
  actions: {
    remediate: ["ELBv2:deleteListener"],
    rollback: ["ELBv2:createListener"],
  },
  permissions: {
    remediate: ["elasticloadbalancing:DeleteListener"],
    rollback: ["elasticloadbalancing:CreateListener"],
  },
  realtime_triggers: [
      ...
      function (region, rcb) {
        ...
        async.each(
          ...
          function (lb, cb) {
            ...
            if (
              describeListeners &&
              describeListeners.data &&
              describeListeners.data.Listeners &&
              describeListeners.data.Listeners.length
            ) {
              noListeners = false;
