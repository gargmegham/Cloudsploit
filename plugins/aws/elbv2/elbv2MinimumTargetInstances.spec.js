...
const describeTargetGroups = [
  {
    TargetGroups: [
      {
        TargetGroupArn:
          "arn:aws:elasticloadbalancing:us-east-1:111122223333:targetgroup/ak-39/63d6e6082a3f6607",
...
const createCache = (elbv2, target, health) => {
  ...
  var targetArn =
    target && target.TargetGroups
      ? target.TargetGroups[0].TargetGroupArn
      : null;
    ...
    elbv2: {
      ...
      describeTargetGroups: {
        "us-east-1": {
          err: {
            message:
              "error describing Application/Network load balancer target groups",
          },
        },
      },
      describeTargetHealth: {
        "us-east-1": {
          err: {
            message:
              "error describing Application/Network load balancer target healths",
          },
        },
      },
    },
