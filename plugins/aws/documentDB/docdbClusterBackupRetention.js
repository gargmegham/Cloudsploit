...
module.exports = {
  ...
  settings: {
    doc_db_backup_retention_threshold: {
      ...
      description:
        "Desired number of days for DocumentDB cluster backup retention period.",
      regex: "^[1-35]*$",
      default: 7,
    },
  },
  ...
  run: function (cache, settings, callback) {
    ...
    var doc_db_backup_retention_threshold = parseInt(
      settings.doc_db_backup_retention_threshold ||
        this.settings.doc_db_backup_retention_threshold.default
    );
      ...
      function (region, rcb) {
        ...
        for (let cluster of describeDBClusters.data) {
          ...
          if (
            ...
            cluster.BackupRetentionPeriod >= doc_db_backup_retention_threshold
          ) {
            helpers.addResult(
              results,
              0,
