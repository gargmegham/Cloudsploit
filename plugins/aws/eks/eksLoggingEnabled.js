...
module.exports = {
  ...
  more_info:
    "EKS supports routing of cluster event and audit logs to CloudWatch, including control plane logs. All logs should be sent to CloudWatch for security analysis.",
  ...
  remediation_description:
    "EKS logging will be enabled for all supported services.",
  remediation_min_version: "202006221808",
  apis_remediate: ["EKS:listClusters", "EKS:describeCluster"],
  actions: {
    remediate: ["EKS:updateClusterConfig"],
        ...
        for (var c in listClusters.data) {
          ...
          if (
            ...
            for (var l in describeCluster.data.cluster.logging.clusterLogging) {
              var group =
                describeCluster.data.cluster.logging.clusterLogging[l];
            ...
            if (logEnabled.length && logDisabled.length) {
              ...
              helpers.addResult(
                results,
                2,
                "EKS cluster logging is disabled for: " +
                  logDisabled.join(", ") +
                  " logs",
                region,
                arn
