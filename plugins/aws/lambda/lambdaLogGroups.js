        ...
        for (var f in listFunctions.data) {
          ...
          if (
            ...
            if (found) {
              ...
              var lambdaEdgeLogGroupName =
                "/aws/lambda/" + region + "." + func.FunctionName;
              for (var cloudwatchRegion of regions.cloudwatchlogs) {
                ...
                var foundLogGroup = regionLogGroups.data.find(
                  (logGroup) => logGroup.logGroupName === lambdaEdgeLogGroupName
                );
                if (foundLogGroup) {
                  result = [
                    0,
                    "Function has lambda@edge log group: " +
