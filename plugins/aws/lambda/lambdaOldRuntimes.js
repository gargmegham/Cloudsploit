  ...
  run: function (cache, settings, callback) {
    ...
    var deprecatedRuntimes = [
      ...
      { id: "nodejs12.x", name: "Node.js 12", endOfLifeDate: "2023-03-31" },
      {
        id: "dotnetcore3.1",
        name: ".Net Core 3.1",
        endOfLifeDate: "2023-03-31",
      },
      {
        id: "dotnetcore2.1",
        name: ".Net Core 2.1",
        endOfLifeDate: "2022-04-15",
      },
      {
        id: "dotnetcore2.0",
        name: ".Net Core 2.0",
        endOfLifeDate: "2018-10-01",
      },
      {
        id: "dotnetcore1.0",
        name: ".Net Core 1.0",
        endOfLifeDate: "2019-06-27",
      },
    ...
    async.each(
      ...
      function (region, rcb) {
        ...
        for (var f in listFunctions.data) {
          ...
          var runtimeDeprecationDate =
            deprecatedRuntime &&
            deprecatedRuntime.length &&
            deprecatedRuntime[0].endOfLifeDate
              ? deprecatedRuntime[0].endOfLifeDate
              : null;
          let today = new Date();
          let dateToday =
          ...
          if (runtimeDeprecationDate && today > runtimeDeprecationDate) {
            helpers.addResult(
              results,
              2,
              "Lambda is using runtime: " +
                deprecatedRuntime[0].name +
