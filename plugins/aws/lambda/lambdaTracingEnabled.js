...
module.exports = {
  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      lambda_whitelist:
        settings.lambda_whitelist || this.settings.lambda_whitelist.default,
    };

    if (config.lambda_whitelist && config.lambda_whitelist.length) {
          ...
          if (whitelisted) {
            ...
            if (
              ...
              helpers.addResult(
                results,
                2,
                "Function does not have active tracing",
                region,
                resource
              );
            }
