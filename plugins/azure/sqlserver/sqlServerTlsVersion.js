...
module.exports = {
  ...
  more_info:
    "TLS 1.2 or higher should be used for all TLS connections to Microsoft Azure SQL server. This setting applies to all databases associated with the server.",
  recommended_action:
    "Modify SQL server firewall and virtual network settings to set desired minimum TLS version.",
  ...
  settings: {
    sql_server_min_tls_version: {
      ...
      description:
        "Minimum desired TLS version for Microsoft Azure SQL servers",
      regex: "^(1.0|1.1|1.2)$",
      default: "1.2",
    },
  },
  ...
  remediation_description:
    "TLS version 1.2 will be set for the affected SQL server",
  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      sql_server_min_tls_version:
        settings.sql_server_min_tls_version ||
        this.settings.sql_server_min_tls_version.default,
    };
  ...
  remediate: function (config, cache, settings, resource, callback) {
    ...
    var baseUrl =
      "https://management.azure.com/{resource}?api-version=2020-08-01-preview";
    var method = "PATCH";
