...
module.exports = {
  ...
  more_info:
    "Enabling SQL Server Auditing ensures that all activities are being logged properly, including potentially-malicious activity.",
        ...
        servers.data.forEach(function (server) {
          ...
          if (
            ...
            if (!serverBlobAuditingPolicies.data.length) {
              ...
              let auditingEnabled = serverBlobAuditingPolicies.data.find(
              ...
              if (auditingEnabled) {
                ...
                helpers.addResult(
                  results,
                  2,
                  "Server auditing is not enabled on the SQL Server",
                  location,
                  server.id
                );
              }
