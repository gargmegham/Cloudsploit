...
module.exports = {
  ...
  recommended_action:
    "Enable the built-in Azure Policy definition: Audit resource location matches resource group location",
      ...
      function () {
        ...
        if (
          ...
          helpers.addResult(
            results,
            0,
            "The policy to audit matching resource location to resource group location is assigned",
            "global",
          ...
          helpers.addResult(
            results,
            2,
            "No existing assignment for the resource location matches resource group location policy",
            "global"
          );
        }
