...
module.exports = {
  ...
  more_info:
    "Log checkpoints logs queries and errors that arise in the server, enabling faster detection of incidents.",
  recommended_action:
    "Ensure the server parameters for each PostgreSQL server have the log_checkpoints setting enabled.",
