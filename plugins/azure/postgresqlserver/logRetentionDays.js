...
module.exports = {
  ...
  recommended_action:
    "Ensure the server parameters for each PostgreSQL server have the log_retention_days setting set to 4 or more days.",
        ...
        servers.data.forEach(function (server) {
          ...
          if (!configurations || configurations.err || !configurations.data) {
            helpers.addResult(
              results,
              3,
              "Unable to query for PostgreSQL Server configuration: " +
            ...
            if (
              ...
              helpers.addResult(
                results,
                0,
                "Log retention period is greater than 3 days",
                location,
                server.id
              );
            } else {
              helpers.addResult(
                results,
                2,
                "Log retention period is 3 days or less or is not set",
                location,
                server.id
              );
            }
