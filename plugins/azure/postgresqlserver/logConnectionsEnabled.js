...
module.exports = {
  ...
  more_info:
    "Connection logs ensure all attempted and successful connections to the server are logged.",
  recommended_action:
    "Ensure the server parameters for each PostgreSQL server have the log_connections setting enabled.",
