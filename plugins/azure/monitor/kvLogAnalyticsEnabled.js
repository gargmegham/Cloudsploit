...
module.exports = {
  ...
  recommended_action:
    "Send all diagnostic logs for Key Vault from the Azure Monitor service to Log Analytics.",
          ...
          if (
            ...
            if (found) {
              helpers.addResult(
                results,
                0,
                "Key vault analytics is enabled for vault",
                location,
                vault.id
              );
            } else {
              helpers.addResult(
                results,
                2,
                "Key vault analytics is not enabled for vault",
                location,
                vault.id
              );
            }
