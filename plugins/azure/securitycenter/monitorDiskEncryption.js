...
module.exports = {
  ...
  recommended_action:
    "Enable Adaptive Application Controls for Disk Encryption from the Azure Security Center by ensuring AuditIfNotExists setting is used for virtual machines.",
  link: "https://docs.microsoft.com/en-us/azure/security-center/security-center-policy-definitions",
  apis: ["policyAssignments:list"],
  compliance: {
    hipaa:
      "HIPAA requires data to be encrypted at rest. Enabling disk encryption " +
