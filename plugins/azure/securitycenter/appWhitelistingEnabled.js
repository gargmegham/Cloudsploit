...
module.exports = {
  ...
  recommended_action:
    "Enable Adaptive Application Controls for Virtual Machines from the Azure Security Center by ensuring AuditIfNotExists setting is used.",
    ...
    async.each(
      ...
      function (location, rcb) {
        ...
        helpers.checkPolicyAssignment(
          ...
          "Monitor Adaptive Application Whitelisting",
          results,
          location
        );
