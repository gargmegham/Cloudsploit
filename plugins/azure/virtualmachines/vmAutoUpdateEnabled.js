...
module.exports = {
  ...
  more_info:
    "Enabling Auto Update on Azure virtual machines reduces the security risk of missing security patches.",
  ...
  compliance: {
    pci:
      "PCI requires all system components have the latest updates " +
      ...
      function (location, rcb) {
          ...
          if (
            ...
            if (
              ...
              helpers.addResult(
                results,
                0,
                "Automatic updates are enabled for this virtual machine: " +
                  virtualMachine.name,
                location,
                virtualMachine.id
              );
              ...
              helpers.addResult(
                results,
                2,
                "Automatic updates are not enabled for this virtual machine: " +
                  virtualMachine.name,
                location,
                virtualMachine.id
              );
        ...
        if (!found) {
          helpers.addResult(
            results,
            0,
            "Automatic updates are enabled on all Windows virtual machines",
            location
          );
        }
