...
module.exports = {
  ...
  more_info:
    "A managed VM image contains the information necessary to create a VM, including the OS and data disks. Virtual Machines should be launched using managed images to ensure security practices and consistency across all the instances.",
        ...
        virtualMachines.data.forEach((virtualMachine) => {
          if (
            ...
            helpers.addResult(
              results,
              0,
              "VM is launched using Azure managed VM image",
              location,
              virtualMachine.id
            );
          } else {
            helpers.addResult(
              results,
              2,
              "VM is not launched using Azure managed VM image",
              location,
              virtualMachine.id
            );
          }
