...
module.exports = {
  ...
  domain: "Compute",
  description:
    "Determines if the number of VM instances is close to the Azure per-region limit",
  more_info:
    "Azure limits regions to certain numbers of resources. Exceeding those limits could prevent resources from launching.",
  ...
  run: function (cache, settings, callback) {
    var config = {
      ...
      instance_limit:
        settings.instance_limit || this.settings.instance_limit.default,
    };
      ...
      function (location, rcb) {
        ...
        if (virtualMachines.err || !virtualMachines.data) {
          helpers.addResult(
            results,
            3,
            "Unable to query Virtual Machines: " +
