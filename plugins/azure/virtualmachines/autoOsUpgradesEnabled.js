...
module.exports = {
  ...
  domain: "Compute",
  description:
    "Ensure that automatic operating system (OS) upgrades are enabled for Microsoft Azure virtual machine scale sets.",
  more_info:
  ...
  recommended_action:
    "Enable automatic OS upgrades under operating system settings",
    ...
    async.each(
      ...
      (location, rcb) => {
        ...
        virtualMachineScaleSets.data.forEach((virtualMachineScaleSet) => {
          if (
            virtualMachineScaleSet.upgradePolicy &&
