...
module.exports = {
  ...
  more_info:
    "Turning on Microsoft Defender for Containers enables threat detection, providing threat intelligence, anomaly detection, and behavior analytics in the Microsoft Defender for Cloud.",
  recommended_action:
    "Enable Microsoft Defender for Containers in Defender plans for the subscription.",
  ...
  run: function (cache, settings, callback) {
    ...
    async.each(
      ...
      function (location, rcb) {
        ...
        let containersPricing = pricings.data.find(
          (pricing) => pricing.name.toLowerCase() === "containers"
        );
