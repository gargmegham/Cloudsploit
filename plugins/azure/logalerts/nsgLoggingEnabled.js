...
module.exports = {
  ...
  more_info:
    "Monitoring for create or update and delete Network Security Group events gives insight into network access changes and may reduce the time it takes to detect suspicious activity.",
  recommended_action:
    "Add a new log alert to the Alerts service that monitors for Network Security Group create or update and delete events.",
  ...
  remediation_description:
    "A Network Security Group log alert will be created to monitor create, update and delete actions",
  ...
  actions: {
    remediate: ["activityLogAlerts:write"],
    rollback: ["activityLogAlerts:write"],
  },
  permissions: {
    remediate: ["activityLogAlerts:write"],
    rollback: ["activityLogAlerts:write"],
  ...
  realtime_triggers: [
    "microsoftinsights:activitylogalerts:write",
    "microsoftinsights:activitylogalerts:delete",
  ],
  ...
  remediate: function (config, cache, settings, resource, callback) {
    ...
    var method = "PUT";
    var baseUrl =
      "https://management.azure.com/{resource}?api-version=2017-04-01";

    if (
      settings.input &&
      settings.input.nsgResourceGroup &&
      settings.input.nsgActionGroup
    ) {
      var thisResource =
        resource +
        `/resourceGroups/${settings.input.nsgResourceGroup}/providers/microsoft.insights/activityLogAlerts/AquaWaveNSGLogAlert`;
      ...
      var body = {
        ...
        properties: {
          ...
          description:
            "Log alert created by Aqua Wave for Network Security Group create, update and delete actions",
        },
      };
