...
module.exports = {
  ...
  more_info:
    "Monitoring for create/update and delete Key Vault events gives insight into network access changes and may reduce the time it takes to detect suspicious activity.",
  recommended_action:
    "Add a new log alert to the Alerts service that monitors for Key Vault create/update and delete events.",
