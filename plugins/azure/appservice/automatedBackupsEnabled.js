...
module.exports = {
  ...
  more_info:
    "Protect your Azure App Services web applications against accidental deletion and/or corruption, you can configure application backups to create restorable copies of your app content.",
          ...
          function (webApp, scb) {
            ...
            if (!configs || !configs.data) {
              helpers.addResult(
                results,
                2,
                "Backups are not configured for WebApp",
                location,
                webApp.id
              );
            } else {
              helpers.addResult(
                results,
                0,
                "Backups are configured for WebApp",
                location,
                webApp.id
              );
            }
