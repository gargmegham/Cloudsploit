...
module.exports = {
  ...
  description:
    "Ensures a system or user assigned managed identity is enabled to authenticate to App Services without storing credentials in the code.",
  more_info:
  ...
  recommended_action:
    "Enable system or user-assigned identities for all App Services and avoid storing credentials in code.",
  link: "https://docs.microsoft.com/en-us/azure/app-service/overview-managed-identity",
  apis: ["webApps:list"],
  remediation_min_version: "202101041500",
  remediation_description:
    "The web app will be assigned a system manager identity",
        ...
        webApps.data.forEach(function (webApp) {
          if (webApp.identity) {
            helpers.addResult(
              results,
              0,
              "The App Service has identities assigned",
              location,
              webApp.id
            );
          } else {
            helpers.addResult(
              results,
              2,
              "The App Service does not have an identity assigned",
              location,
              webApp.id
            );
          }
