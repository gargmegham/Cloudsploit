...
module.exports = {
  ...
  more_info:
    "App Services currently allows web apps to use TLS versions 1.0, 1.1 and 1.2. It is highly recommended to use the latest TLS 1.2 version for web app TLS connections.",
  recommended_action:
    "Set the minimum TLS version to 1.2 for all App Services.",
  ...
  compliance: {
    pci:
      "PCI requires all web applications encrypt data " +
          ...
          if (!webConfigs || webConfigs.err || !webConfigs.data) {
            ...
            if (
              ...
              helpers.addResult(
                results,
                0,
                "Minimum TLS version criteria is satisfied",
                location,
                webApp.id
              );
            } else {
              helpers.addResult(
                results,
                2,
                "Minimum TLS version is not 1.2",
                location,
                webApp.id
              );
            }
  ...
  remediate: function (config, cache, settings, resource, callback) {
    ...
    var baseUrl =
      "https://management.azure.com/{resource}?api-version=2021-02-01";
    var method = "PATCH";
