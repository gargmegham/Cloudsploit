...
module.exports = {
  ...
  actions: {
    remediate: ["webApps:updateconfiguration"],
    rollback: ["webApps:updateconfiguration"],
  },
  permissions: {
    remediate: ["webApps:updateconfiguration"],
    rollback: ["webApps:updateconfiguration"],
      ...
      function (location, rcb) {
        ...
        webApps.data.forEach((webApp) => {
          ...
          if (
            ...
            let denyAllIp;
            if (
              webConfigs.data[0].ipSecurityRestrictions &&
              webConfigs.data[0].ipSecurityRestrictions.length
            ) {
              denyAllIp = webConfigs.data[0].ipSecurityRestrictions.find(
  ...
  remediate: function (config, cache, settings, resource, callback) {
    ...
    var baseUrl =
      "https://management.azure.com/{resource}/config/web?api-version=2021-02-01";
    var method = "PATCH";
