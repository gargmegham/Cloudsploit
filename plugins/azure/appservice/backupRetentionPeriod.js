...
module.exports = {
  ...
  more_info:
    "Retaining application backups for a longer period of time will allow you to handle your app data restoration process more efficiently.",
  ...
  run: function (cache, settings, callback) {
    ...
    var webapps_backup_retention_period = parseInt(
      settings.webapps_backup_retention_period ||
        this.settings.webapps_backup_retention_period.default
    );
        ...
        async.each(
          ...
          function (webApp, scb) {
            ...
            if (backupSchedule && backupSchedule.retentionPeriodInDays) {
              if (
                backupSchedule.retentionPeriodInDays >=
                webapps_backup_retention_period
              ) {
                helpers.addResult(
                  results,
