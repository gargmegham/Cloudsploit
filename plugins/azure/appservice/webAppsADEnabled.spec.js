...
const webApps = [
  {
    ...
    selfLink:
      "https://waws-prod-dm1-213.api.azurewebsites.windows.net:454/subscriptions/abcdefg-ebf6-437f-a3b0-28fc0d22117e/webspaces/test-CentralUSwebspace-Linux/sites/test",
    repositorySiteName: "test",
    owner: null,
    usageState: "Normal",
    enabled: true,
    adminEnabled: true,
    enabledHostNames: ["test.azurewebsites.net", "test.scm.azurewebsites.net"],
  },
  {
