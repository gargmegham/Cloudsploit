...
module.exports = {
  ...
  domain: "Storage",
  description:
    "Ensures Microsoft Azure Storage Accounts are using the latest TLS version 1.2 to enforce stricter security measure.",
  more_info:
    "Azure Storage accounts permit clients to send and receive data with the oldest version of TLS, TLS 1.0, and above. " +
  ...
  recommended_action:
    "Modify Storage Account configuration and set desired minimum TLS version",
  ...
  settings: {
    sa_min_tls_version: {
      ...
      description:
        "Minimum desired TLS version for Microsoft Azure Storage Accounts",
      regex: "^(1.0|1.1|1.2)$",
      default: "1.2",
    },
  },
  ...
  remediation_description:
    "TLS version 1.2 will be set for the affected Storage Accounts",
  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      sa_min_tls_version:
        settings.sa_min_tls_version || this.settings.sa_min_tls_version.default,
    };
    ...
    async.each(
      ...
      function (location, rcb) {
        ...
        storageAccounts.data.forEach(function (storageAccount) {
          ...
          let tlsVersion = storageAccount.minimumTlsVersion
            ? storageAccount.minimumTlsVersion
            : "TLS1.0"; //Default is TLS 1.0
