...
module.exports = {
  ...
  recommended_action:
    "Ensure all Storage Accounts are configured with a BYOK key.",
  ...
  compliance: {
    ...
    pci:
      "PCI requires proper encryption of cardholder data at rest. " +
            ...
            if (allowRegex && allowRegex.test(account.name)) {
              ...
              if (
                ...
                helpers.addResult(
                  results,
                  0,
                  "Storage Account encryption is configured with Microsoft Key vault",
                  location,
                  account.id
                );
              } else if (
                ...
                helpers.addResult(
                  results,
                  2,
                  "Storage Account encryption is configured using Microsoft Default Storage Keys",
                  location,
                  account.id
                );
              } else {
                helpers.addResult(
                  results,
                  2,
                  "Storage Account is not configured for data-at-rest encryption",
                  location,
                  account.id
                );
              }
