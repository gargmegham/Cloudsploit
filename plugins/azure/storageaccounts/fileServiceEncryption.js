...
module.exports = {
  ...
  more_info:
    "File Service encryption protects your data at rest. Azure Storage encrypts your data and automatically decrypts it for you as you access it.",
  recommended_action:
    "Ensure that data encryption is enabled for each File Service.",
        ...
        storageAccounts.data.forEach((storageAccount) => {
          if (
            ...
            helpers.addResult(
              results,
              0,
              "Encryption is enabled on the File Service",
              location,
              storageAccount.id
            );
          } else {
            helpers.addResult(
              results,
              2,
              "Encryption is disabled on the File Service",
              location,
              storageAccount.id
            );
          }
