...
module.exports = {
  ...
  more_info:
    "A principal such as a user, group or application should have access to execute only specific operations for Azure Key Vault keys, secrets or certificates as a security best practice.",
  recommended_action:
    "Ensure that no Microsoft Azure user, group or application is using administrator privileges.",
        ...
        vaults.data.forEach((vault) => {
          ...
          if (policyFound) {
            helpers.addResult(
              results,
              2,
              "User/Group or Application has full access to the vault",
              location,
              vault.id
            );
          } else {
            helpers.addResult(
              results,
              0,
              "No User/Group or Application has full access to the vault",
              location,
              vault.id
            );
          }
