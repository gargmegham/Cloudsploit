...
module.exports = {
  ...
  recommended_action:
    "Ensure each Key Vault has an expiry time set that provides for sufficient rotation.",
              ...
              if (secret.attributes) {
                ...
                if (!attributes.enabled) {
                  ...
                  helpers.addResult(
                    results,
                    0,
                    "Expiry date is set for the secret",
                    location,
                    secretId
                  );
                } else {
                  helpers.addResult(
                    results,
                    2,
                    "Expiry date is not set for the secret",
                    location,
                    secretId
                  );
                }
