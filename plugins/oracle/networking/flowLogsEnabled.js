...
module.exports = {
  ...
  more_info:
    "VCN flow logs allow you to monitor traffic flowing within your virtual network and can help in detecting anomalous traffic.",
            ...
            if (logs && !logs.err && logs.data && logs.data.length) {
              subnetFlowLog = logs.data.find(
                (log) =>
                  ...
                  log.configuration.source.service === "flowlogs" &&
