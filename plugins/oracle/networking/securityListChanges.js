      ...
      function (region, rcb) {
        if (helpers.checkRegionSubscription(cache, source, results, region)) {
          ...
          const eventsToCheck = [
            {
              displayName: "Create",
              value: "com.oraclecloud.virtualnetwork.createsecuritylist",
            },
            {
              displayName: "Update",
              value: "com.oraclecloud.virtualnetwork.updatesecuritylist",
            },
            {
              displayName: "Delete",
              value: "com.oraclecloud.virtualnetwork.deletesecuritylist",
            },
            {
