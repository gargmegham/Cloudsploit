...
module.exports = {
  ...
  more_info:
    "Monitoring changes to security groups like create, update and delete will help in identifying changes to the security controls.",
  link: "https://docs.oracle.com/en-us/iaas/Content/Events/Task/managingrules.htm",
  recommended_action:
    "Configure an event rule for security group changes like create, update and delete.",
  apis: ["rules:list"],
