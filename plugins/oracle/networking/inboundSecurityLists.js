...
module.exports = {
  ...
  more_info:
    "To control network access to your instancesx, it is recommended that Virtual Cloud Networks (VCN) security lists are configured with ingress rules which provide stateful and stateless firewall capability.",
          ...
          securityLists.data.forEach((securityList) => {
            if (
              ...
              helpers.addResult(
                results,
                0,
                `Security list has ingress rules configured`,
                region,
                securityList.id
              );
            } else {
              helpers.addResult(
                results,
                2,
                `Security list does not have ingress rules configured`,
                region,
                securityList.id
              );
            }
