...
const buckets = [
  {
    ...
    compartmentId:
      "ocid1.tenancy.oc1..11111111111111111222222222222222222333333333333333",
    createdBy:
      "ocid1.user.oc1..11111111111111112222222222222223333333333333333",
...
describe("bucketWriteLogsEnabled", function () {
  describe("run", function () {
    ...
    it("should give failing result if the bucket does not have write level logs enabled", function (done) {
      ...
      const cache = createCache(null, [buckets[0]]);
    ...
    it("should give passing result if the bucket has write level logs enabled", function (done) {
      ...
      const cache = createCache(null, [buckets[1]]);
