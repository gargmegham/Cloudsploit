...
const user = [
  ...
  },
  {
    ...
    emailVerified: true,
    identityProviderId:
      "ocid1.saml2idp.oc1..aaaaaaaaknersalsctbatwefdwefdwdxwvnyxpdzlbs4vuuu7zxgjxqts6a",
    ...
    compartmentId:
      "ocid1.tenancy.oc1..aaaaaaaaidksdowchziencs3c3zx4gmpw3weung65id5bdjyw24nbdqih4ya",
...
describe("usersMfaEnabled", function () {
  describe("run", function () {
    ...
    it("should give passing result if No user accounts found", function (done) {
      ...
      const cache = createCache(null, [user[1]]);
    ...
    it("should give failing result if user has MFA disabled", function (done) {
      ...
      const cache = createCache(null, user);
