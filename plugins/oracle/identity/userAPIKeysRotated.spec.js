...
const apiKeys = [
  {
    ...
    keyValue: "",
    keyId:
      "ocid1.tenancy.oc1..aaaaaaaaip36ginmudtormvwsv45imsyctt3vhme6rnemweaxe4b6q2gcodq/ocid1.user.oc1..aaaaaaaaddzcrvo7kdxa/65:ab:7d:b9:54:a8:7e:c7:42:cb:5a:87:2f:ed:08:d3",
...
describe("userAPIKeysRotated", function () {
  describe("run", function () {
    ...
    it("should give failing result API keys has not been rotated within set days limit", function (done) {
      ...
      const cache = createCache([apiKeys[1]]);
    ...
    it("should give passing result API keys has been rotated within set days limit", function (done) {
      ...
      const cache = createCache([apiKeys[0]]);
