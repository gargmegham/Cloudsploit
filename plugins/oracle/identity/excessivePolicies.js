...
module.exports = {
  ...
  description:
    "Determine if there are an excessive number of policies in the account",
  more_info:
    "Keeping the number of policies to a minimum helps reduce the chances of " +
  ...
  recommended_action:
    "Limit the number of policies to prevent accidental authorizations",
  ...
  settings: {
    excessive_policy_fail: {
      ...
      description:
        "Return a failing result when the number of Policies exceeds this value",
      regex: "^[1-9]{1}[0-9]{0,5}$",
      default: 25,
    },
    excessive_policy_warn: {
      ...
      description:
        "Return a warning result when the number of Policies exceeds this value",
      regex: "^[1-9]{1}[0-9]{0,5}$",
      default: 15,
    },
  },
  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      excessive_policy_fail:
        settings.excessive_policy_fail ||
        this.settings.excessive_policy_fail.default,
      excessive_policy_warn:
        settings.excessive_policy_warn ||
        this.settings.excessive_policy_warn.default,
    };
