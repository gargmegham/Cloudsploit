...
module.exports = {
  ...
  recommended_action:
    "Update the password policy to require a minimum password length.",
      ...
      if (passwordPolicy && passwordPolicy.minimumPasswordLength) {
        if (passwordPolicy.minimumPasswordLength >= 14) {
          ...
          helpers.addResult(
            ...
            "Minimum password length of: " +
              passwordPolicy.minimumPasswordLength +
              " is less than the recommended 14 characters",
            "global",
            authenticationPolicy.data.compartmentId
          );
        } else if (
          ...
          helpers.addResult(
            results,
            2,
            "Password policy does not require a minimum password length",
            "global",
            authenticationPolicy.data.compartmentId
          );
        }
