...
module.exports = {
  ...
  description:
    "Determine if there are an excessive number of policy statements in the account",
  more_info:
    "Keeping the number of policy statements to a minimum helps reduce the chances " +
  ...
  recommended_action:
    "Limit the number of policy statements to prevent accidental authorizations",
  ...
  settings: {
    excessive_policy_statement_fail: {
      ...
      description:
        "Return a failing result when the number of Policy Statements exceeds this value",
      regex: "^[1-9]{1}[0-9]{0,5}$",
      default: 25,
    },
    excessive_policy_statement_warn: {
      ...
      description:
        "Return a warning result when the number of Policy Statements exceeds this value",
      regex: "^[1-9]{1}[0-9]{0,5}$",
      default: 15,
    },
  },
  ...
  run: function (cache, settings, callback) {
    ...
    var config = {
      excessive_policy_statement_fail:
        settings.excessive_policy_statement_fail ||
        this.settings.excessive_policy_statement_fail.default,
      excessive_policy_statement_warn:
        settings.excessive_policy_statement_warn ||
        this.settings.excessive_policy_statement_warn.default,
    };
