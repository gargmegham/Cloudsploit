...
module.exports = {
  ...
  more_info:
    "Monitoring Identity Provider changes like create, update and delete will help in identifying changes to the security posture.",
  link: "https://docs.oracle.com/en-us/iaas/Content/Events/Task/managingrules.htm",
  recommended_action:
    "Configure an event rule for Identity Provider changes like create, update and delete.",
  apis: ["rules:list"],
