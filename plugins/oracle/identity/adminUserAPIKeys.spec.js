          ...
          data: [
            {
              ...
              groupId:
                "ocid1.group.oc1..pidxp7gzxcmsfxyow2p6i6siyagvgdysbuk7iq",
              id: "ocid1.groupmembership.oc1..aaaaaaaabis5ze6hqgxd77hn3j7z6vy6m3xtq6ydzo2hc3j6hnod37hsh6fq",
              compartmentId:
                "ocid1.tenancy.oc1..aaaaaasyctt3vhme6rnemweaxe4b6q2gcodq",
              description:
                "GRP_MBR:ocid1.group.oc1..pidxp7gzxcmsfxyow2p6i6siyagvgdysbuk7iq-ocid1.user.oc1..aaaaaaaarekfkxmha6u5cyvqjkmvo7kdxa",
            ...
            },
            {
              ...
              compartmentId:
                "ocid1.tenancy.oc1..aaaaaasyctt3vhme6rnemweaxe4b6q2gcodq",
              description:
                "GRP_MBR:ocid1.group.oc1..pidxp7gzxcmsfxyow2p6i6siyagvgdysbuk7iq-ocid1.user.oc1..aaadnfbtjs35pen2qr3b3tzqmq",
              timeCreated: "2022-01-04T17:00:10.630Z",
              lifecycleState: "ACTIVE",
            },
            {
              userId:
                "ocid1.user.oc1..aaaaaaaaqii64e6rkq55nm36h37rvvei3wq43nfuyvg5vsnh5t7sftwgyw3q",
              groupId:
                "ocid1.group.oc1..pidxp7gzxcmsfxyow2p6i6siyagvgdysbuk7iq",
              ...
              compartmentId:
                "ocid1.tenancy.oc1..aaaaaasyctt3vhme6rnemweaxe4b6q2gcodq",
              description:
                "GRP_MBR:ocid1.group.oc1..pidxp7gzxcmsfxyow2p6i6siyagvgdysbuk7iq-ocid1.user.oc1..aaaaaaaaqii64e6rkq55nm36h37rvvei3wq43nfuyvg5vsnh5t7sftwgyw3q",
              timeCreated: "2022-01-04T16:41:28.470Z",
              lifecycleState: "ACTIVE",
            },
            {
              userId: "ocid1.user.oc1..aaaaaaaarekfkxmha6u5cyvqjkmvo7kdxa",
              groupId:
                "ocid1.group.oc1..aaaaaaaatf7gxukphgsxjpk7ypge6jd6ilxuwp4pfsvwjzvfloirep42o3kq",
              id: "ocid1.groupmembership.oc1..aaaaaaaaqed6hoql3ud5ekesy7kchjqjrrhdcnv7qt3mhgpqrxzaxdaaowva",
              compartmentId:
                "ocid1.tenancy.oc1..aaaaaasyctt3vhme6rnemweaxe4b6q2gcodq",
              description:
                "GRP_MBR:ocid1.group.oc1..aaaaaaaatf7gxukphgsxjpk7ypge6jd6ilxuwp4pfsvwjzvfloirep42o3kq-ocid1.user.oc1..aaaaaaaarekfkxmha6u5cyvqjkmvo7kdxa",
          ...
          data: [
            {
              ...
              keyValue: "",
              keyId:
                "ocid1.tenancy.oc1..aaaaa2gcodq/ocid1.user.oc1..aaaaaaaarekfkxmha6u5cyvqjkmvo7kdxa/65:ab:7d:b9:54:a8:7e:c7:42:cb:5a:87:2f:ed:08:d3",
              lifecycleState: "ACTIVE",
...
describe("adminUserAPIKeys", function () {
  describe("run", function () {
    it("should give unknown result if unable to query for users", function (done) {
      ...
      const cache = createCache(undefined, {}, { err: "no data found" });
    ...
    it("should give failing result API keys exist for admin user", function (done) {
      ...
      const cache = createCache([users[1]], groups);
    ...
    it("should give passing result API key does not exist for admin user", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "API key does not exist for admin user"
        );
        expect(results[0].region).to.equal("global");
        done();
      };

      const cache = createCache([users[0]], groups);
    ...
    it("should give unknown result if unable to query user group", function (done) {
      ...
      const cache = createCache([users[1]], null, null);
