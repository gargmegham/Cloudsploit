...
describe("dbPrivateSubnetOnly", function () {
  describe("run", function () {
    it("should give unknown result if a db system error is passed or no data is present", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "Unable to query for database systems:"
        );
        expect(results[0].region).to.equal("us-ashburn-1");
        done();
      };

      const cache = createCache(["hello"], undefined);
    ...
    it("should give unknown result if a subnet error is passed or no data is present", function (done) {
      ...
      const cache = createCache(null, ["hello"], undefined, ["hello"]);
    ...
    it("should give passing result if no subnets are found", function (done) {
      ...
      const cache = createCache(null, ["hello"], [], null);
    ...
    it("should give passing result if no db systems are found", function (done) {
      ...
      const cache = createCache(null, [], ["data"], null);
    ...
    it("should give failing result if database systems are in public subnets", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].message).to.include(
          "The DB system is in a public subnet"
        );
        expect(results[0].region).to.equal("us-ashburn-1");
        done();
      };
        ...
        [
          {
            ...
            clusterName: null,
            compartmentId:
              "ocid1.tenancy.oc1..aaaaaaaao43aqdrzuacodg7ffqv2zeauftjyjkwhnbrugt44ympzeiblxx7q",
            cpuCoreCount: 1,
            ...
            lifecycleDetails:
              "Hostname oraclehello is already in-use in this subnet ocid1.subnet.oc1.iad.aaaaaaaazwuooxeivkzmb622gwvlthykwalti333cdtjr7mdbrbtk6ybalhq. Please terminate & re-provision the instance with a non-overlapping hostname.",
            ...
            subnetId:
              "ocid1.subnet.oc1.iad.aaaaaaaazwuooxeivkzmb622gwvlthykwalti333cdtjr7mdbrbtk6ybalhq",
          ...
          },
          {
            ...
            recoStorageSizeInGB: 256,
            scanDnsRecordId:
              "ocid1.vcndnsrecord.oc1.iad.abuwcljtvbjvzkqlfsgc4ig2cbybfz7wamzy274rs6otkdlelnvwnzz2tk5a",
            scanIpIds: null,
            shape: "VM.Standard2.1",
            sparseDiskgroup: null,
            sshPublicKeys: [
        ...
        [
          {
            ...
            definedTags: {},
            dhcpOptionsId:
              "ocid1.dhcpoptions.oc1.iad.aaaaaaaafnnevu3kpld76oriye2llmxexctk5b5p2bpclxbn655okva2h2la",
            ...
            routeTableId:
              "ocid1.routetable.oc1.iad.aaaaaaaa6ihfuq4kr5i46rakq3uunbglbnlxnaoyt3u63xo4qmcdhjnbod4a",
            securityListIds: [
            ...
            vcnId:
              "ocid1.vcn.oc1.iad.aaaaaaaaihl7n5qajssmue7fse6g2wkmtsbihpad7rhqcxqwnuu5sriv3wfq",
          ...
          },
          {
            ...
            definedTags: {},
            dhcpOptionsId:
              "ocid1.dhcpoptions.oc1.iad.aaaaaaaa4ytfmktadjazpa6o4ponigkha5qmydkxrac6vcirdshejakxwmnq",
            displayName: "Public Subnet fMgC:US-ASHBURN-AD-3",
            freeformTags: {},
            ...
            prohibitPublicIpOnVnic: false,
            routeTableId:
              "ocid1.routetable.oc1.iad.aaaaaaaayqkxq4lotwh7vzorhkcc2tdv5jnt5z464hnbaijfwjsolpmnctiq",
            securityListIds: [
            ...
            vcnId:
              "ocid1.vcn.oc1.iad.aaaaaaaakw2ep6iemb6wy3pexoox63rjpqlnyjinzdoyewee7e22zhrbqp7q",
            virtualRouterIp: "10.0.2.1",
          ...
          },
          {
            ...
            definedTags: {},
            dhcpOptionsId:
              "ocid1.dhcpoptions.oc1.iad.aaaaaaaa4xhwhj6zip45qg7bv7cpb5kop23wuii6ymlmkloulpnxw4d6lsra",
            ...
            routeTableId:
              "ocid1.routetable.oc1.iad.aaaaaaaags5xhytolz3wasw6u6ca7kcvlvksvnikljhd4klo6nftsvymabeq",
            securityListIds: [
            ...
            vcnId:
              "ocid1.vcn.oc1.iad.aaaaaaaa5irgqmsbonndgikthiruk3porpadlpojbd5saooulz4mcf7gdfra",
    ...
    it("should give passing result if database systems are in private subnets", function (done) {
      const callback = (err, results) => {
        ...
        expect(results[0].status).to.equal(0);
        expect(results[0].message).to.include(
          "The DB system is in a private subnet"
        );
        expect(results[0].region).to.equal("us-ashburn-1");
        done();
      };
