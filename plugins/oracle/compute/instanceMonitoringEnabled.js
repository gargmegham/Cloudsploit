...
module.exports = {
  ...
  more_info:
    "Enabling instance monitoring allows for metrics to be collected on the instance. Following security best practices. ",
  recommended_action:
    "When creating a new instance, ensure monitoring is enabled under advanced settings.",
