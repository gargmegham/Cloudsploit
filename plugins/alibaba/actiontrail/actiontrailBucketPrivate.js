...
module.exports = {
  ...
  more_info:
    "When you allow public-access on an OSS bucket, all Internet users can access the objects in the bucket " +
    ...
    async.each(
      ...
      function (region, rcb) {
        ...
        for (let trail of describeTrails.data) {
          ...
          var bucketLocation =
            getBucketInfo && getBucketInfo.data && getBucketInfo.data.Location
              ? getBucketInfo.data.Location
              : region;
          ...
          if (
            getBucketInfo.data.AccessControlList &&
