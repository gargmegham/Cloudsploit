...
module.exports = {
  ...
  domain: "Databases",
  description:
    "Ensure that log_connections parameter is set to ON for RDS instances.",
  more_info:
    "RDS instance provide the feature of logging details of establishing a connection to the server " +
  ...
  recommended_action:
    "Modify RDS DB instance to set value for log_connections parameter to ON",
  apis: [
          ...
          function (instance, cb) {
            ...
            if (
              ...
              let found = parameters.find(
                (parameter) =>
                  parameter.ParameterName == "log_connections" &&
