...
module.exports = {
  ...
  domain: "Databases",
  description:
    "Ensure that RDS DB instances have log_duration parameter enabled.",
  more_info:
    "Enabling log_duration parameter logs the duration of each completed SQL statement generating query and error logs " +
  ...
  recommended_action:
    "Modify RDS DB instances to set value for log_duration parameter to ON",
  apis: [
          ...
          function (instance, cb) {
            ...
            if (
              ...
              let found = parameters.find(
                (parameter) =>
                  parameter.ParameterName == "log_duration" &&
