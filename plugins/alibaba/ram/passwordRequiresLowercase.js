...
module.exports = {
  ...
  description:
    "Ensure that RAM password security settings require at least one lowercase character.",
  more_info:
  ...
  recommended_action:
    "Update the password security settings to require the use of lowercase characters.",
  ...
  run: function (cache, settings, callback) {
    ...
    if (getPasswordPolicy.data.RequireLowercaseCharacters) {
      helpers.addResult(
        results,
        0,
        "RAM password security policy requires lowercase characters",
        region
      );
    } else {
      helpers.addResult(
        results,
        2,
        "RAM password security policy does not require lowercase characters",
        region
      );
    }
