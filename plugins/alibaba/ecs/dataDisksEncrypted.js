...
module.exports = {
  ...
  run: function (cache, settings, callback) {
    ...
    var targetEncryptionLevel = encryptionLevels.indexOf(
      settings.data_disks_encryption_level ||
        this.settings.data_disks_encryption_level.default
    );
    ...
    async.each(
      ...
      function (region, rcb) {
        ...
        async.each(
          describeDisks.data,
          (disk, dcb) => {
            if (!disk.DiskId || disk.Type.toLowerCase() !== "data")
              return dcb();
