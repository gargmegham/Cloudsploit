...
module.exports = {
  ...
  domain: "Compute",
  description:
    "Ensure that security groups does not have TCP port 9200 for Elasticsearch open to the public.",
  more_info:
  ...
  recommended_action:
    "Restrict TCP port 9200 for Elasticsearch to known IP addresses",
  apis: [
