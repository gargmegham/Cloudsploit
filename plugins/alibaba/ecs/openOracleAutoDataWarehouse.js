...
module.exports = {
  ...
  domain: "Compute",
  description:
    "Ensure that security groups does not have TCP port 1522 for Oracle Auto Data Warehouse open to the public.",
  more_info:
  ...
  recommended_action:
    "Restrict TCP port 1522 for Oracle Auto Data Warehouse to known IP addresses",
  apis: [
