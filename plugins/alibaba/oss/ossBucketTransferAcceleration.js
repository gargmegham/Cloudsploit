...
module.exports = {
  ...
  more_info:
    "Enabling Transfer Acceleration for OSS buckets provides an optimized end-to-end acceleration solution to access OSS over the Internet.",
  ...
  run: function (cache, settings, callback) {
    ...
    async.each(
      ...
      (bucket, cb) => {
        ...
        if (
          getBucketInfo.data.TransferAcceleration &&
