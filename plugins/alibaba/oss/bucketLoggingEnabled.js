...
module.exports = {
  ...
  more_info:
    "Enabling logging for OSS buckets provides visibility into request made to access bucket objects which can be useful in auditing and security workflows.",
  ...
  run: function (cache, settings, callback) {
    ...
    async.each(
      ...
      (bucket, cb) => {
        ...
        if (
          getBucketInfo.data.BucketPolicy &&
