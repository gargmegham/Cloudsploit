...
module.exports = {
  ...
  more_info:
    "OSS allows you to configure versioning to protect data in buckets. When versioning is enabled for a bucket, " +
  ...
  run: function (cache, settings, callback) {
    ...
    async.each(
      ...
      (bucket, cb) => {
        ...
        if (
          getBucketInfo.data.Versioning &&
          getBucketInfo.data.Versioning.toUpperCase() === "ENABLED"
        ) {
          helpers.addResult(
            results,
            0,
