...
module.exports = {
  ...
  more_info:
    "Enabling Cross region replication for OSS buckets provides automatic and asynchronous replication of objects across buckets in different Object Storage Service (OSS) regions.",
  ...
  run: function (cache, settings, callback) {
    ...
    async.each(
      ...
      (bucket, cb) => {
        ...
        if (
          getBucketInfo.data.CrossRegionReplication &&
