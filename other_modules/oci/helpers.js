  ...
  var makeCall = function (innerOptions) {
    ...
    var request = https.request(innerOptions, function (response) {
      ...
      response.on("end", function () {
        ...
        var parentOcidName;
        var parentOcidVal;
        if (parentOcidArr.length > 3 && parentOcidArr.length % 2 == 1) {
        ...
        } else if (parentOcidArr.length > 3 && parentOcidArr.length % 2 == 0) {
        ...
        if (this.headers && this.headers["opc-next-page"]) {
          innerOptions.path =
            originalPath + "&page=" + this.headers["opc-next-page"];
