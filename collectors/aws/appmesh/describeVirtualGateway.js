...
module.exports = function (AWSConfig, collection, retries, callback) {
  ...
  if (
    ...
    !collection.appmesh.listMeshes[AWSConfig.region].data
  )
    return callback();
  async.eachLimit(
    collection.appmesh.listMeshes[AWSConfig.region].data,
    ...
    function (mesh, cb) {
      ...
      async.eachLimit(
        collection.appmesh.listVirtualGateways[AWSConfig.region][mesh.meshName]
          .data.virtualGateways,
        3,
        function (gateway, pCb) {
          collection.appmesh.describeVirtualGateway[AWSConfig.region][
