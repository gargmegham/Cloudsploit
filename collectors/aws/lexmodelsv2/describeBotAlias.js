...
module.exports = function (AWSConfig, collection, retries, callback) {
  ...
  if (
    ...
    !collection.lexmodelsv2.listBots[AWSConfig.region].data
  )
    return callback();
  async.eachLimit(
    collection.lexmodelsv2.listBots[AWSConfig.region].data,
    ...
    function (bot, cb) {
      ...
      async.eachLimit(
        ...
        3,
        function (alias, pCb) {
          collection.lexmodelsv2.describeBotAlias[AWSConfig.region][
            alias.botAliasId
          ] = {};
          ...
          helpers.makeCustomCollectorCall(
            lexmodelsv2,
            "describeBotAlias",
            { botAliasId: alias.botAliasId, botId: bot.botId },
            retries,
            null,
            null,
            null,
