...
module.exports = function (AWSConfig, collection, retries, callback) {
  ...
  if (
    !collection.sts.getCallerIdentity ||
    !collection.sts.getCallerIdentity["us-east-1"].data
  )
    return callback();

  async.eachLimit(
    collection.cognitoidentityserviceprovider.listUserPools[AWSConfig.region]
      .data,
    15,
    function (up, cb) {
