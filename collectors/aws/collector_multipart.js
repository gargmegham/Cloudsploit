...
var collect = function (AWSConfig, settings, callback) {
  ...
  AWSEC2.describeRegions(params, function (err, accountRegions) {
    ...
    async.eachOfLimit(
      helpers.callsMultipart[callsPart],
      10,
            ...
            async.eachLimit(
              ...
              function (region, regionCb) {
                if (
                  ...
                  helpers.globalServicesMultipart.indexOf(serviceName) === -1
                )
                  return regionCb();
      ...
      function () {
        ...
        async.eachOfLimit(
          helpers.postcallsMultipart[callsPart],
          10,
          function (serviceObj, service, serviceCb) {
            ...
            var sendIntegration =
              helpers.postcallsMultipart[callsPart] &&
              helpers.postcallsMultipart[callsPart][serviceName] &&
              helpers.postcallsMultipart[callsPart][serviceName].sendIntegration
                ? helpers.postcallsMultipart[callsPart][serviceName]
                    .sendIntegration
                : false;
            var serviceIntegration = {
              enabled:
                sendIntegration && sendIntegration.enabled ? true : false,
              sendLast:
                sendIntegration && sendIntegration.sendLast ? true : false,
            };
