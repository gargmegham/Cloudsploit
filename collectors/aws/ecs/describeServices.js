...
module.exports = function (AWSConfig, collection, retries, callback) {
  ...
  async.eachOfLimit(
    ...
    10,
    function (servicesData, instance, cb) {
      async.eachLimit(
        servicesData.data,
        5,
        function (service, ccb) {
          ...
          helpers.makeCustomCollectorCall(
            ...
            function (err, data) {
              if (err) {
                collection.ecs.describeServices[AWSConfig.region][service].err =
                  err;
              }

              collection.ecs.describeServices[AWSConfig.region][service].data =
                data;
