...
module.exports = function (AWSConfig, collection, retries, callback) {
  ...
  async.eachLimit(
    collection.elasticbeanstalk.describeEnvironments[AWSConfig.region].data,
    15,
    function (environment, cb) {
      ...
      helpers.makeCustomCollectorCall(
        ...
        null,
        function (err, data) {
          collection.elasticbeanstalk.describeConfigurationSettings[
            AWSConfig.region
          ...
          if (err || !data) {
            ...
            collection.elasticbeanstalk.describeConfigurationSettings[
              AWSConfig.region
            ][environment.EnvironmentArn].data = data;
          }
          cb();
        }
      );
