...
module.exports = function (AWSConfig, collection, retries, callback) {
  ...
  async.eachLimit(
    collection.autoscaling.describeAutoScalingGroups[AWSConfig.region].data,
    15,
    function (asg, cb) {
      var params = {
      ...
      helpers.makeCustomCollectorCall(
        ...
        null,
        function (err, data) {
          collection.autoscaling.describeNotificationConfigurations[
            AWSConfig.region
          ...
          if (err || !data) {
            ...
            collection.autoscaling.describeNotificationConfigurations[
              AWSConfig.region
            ][asg.AutoScalingGroupARN].data = data;
          }
          cb();
        }
      );
